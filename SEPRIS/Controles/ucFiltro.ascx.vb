...
Public Class ucFiltro
    ...
    Private _ucTemplateControlPath As String = "ASP.controles_filtro"
    ''' <summary>
    ...
    Private _ucPath As String = "~/Controles/filtro/"
    ''' <summary>
    ...
    Protected Sub ucDropDownListR_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucDropDownListR As ddlUserControlR = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, ddlUserControlR)
    ...
    Protected Sub ucCheckList_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucCheckList As chkUserControl = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, chkUserControl)
    ...
    Private Sub removeControl(ByVal obj As Object)
        ...
        Select Case obj.ToString
            Case _ucTemplateControlPath & "_cldusercontrol_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, cldUserControl))
                Session.Remove(DirectCast(obj, cldUserControl).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, cldUserControl).labelText)
            Case _ucTemplateControlPath & "_rbusercontrol_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, rbUserControl))
                Session.Remove(DirectCast(obj, rbUserControl).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, rbUserControl).labelText)
            Case _ucTemplateControlPath & "_txtusercontrol_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, txtUserControl))
                Session.Remove(DirectCast(obj, txtUserControl).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, txtUserControl).labelText)
            Case _ucTemplateControlPath & "_ddlusercontrol_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, ddlUserControl))
                Session.Remove(DirectCast(obj, ddlUserControl).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, ddlUserControl).labelText)
            Case _ucTemplateControlPath & "_ddlusercontrolr_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, ddlUserControlR))
                Session.Remove(DirectCast(obj, ddlUserControlR).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, ddlUserControlR).labelText)
            Case _ucTemplateControlPath & "_chkusercontrol_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, chkUserControl))
                Session.Remove(DirectCast(obj, chkUserControl).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, chkUserControl).labelText)
    ...
    Private Sub CreateTextbox(
        ...
        Dim ucTextBox As txtUserControl = DirectCast(LoadControl(ucPath & "txtUserControl.ascx"), txtUserControl)
    ...
    Private Sub CreateDropDownList(
        ...
        'Crea instancia del control
        Dim ucDropDownList As ddlUserControl = DirectCast(LoadControl(ucPath & "ddlUserControl.ascx"), ddlUserControl)
    ...
    Private Sub CreateDropDownListR(
        ...
        'Crea instancia del control
        Dim ucDropDownListR As ddlUserControlR = DirectCast(LoadControl(ucPath & "ddlUserControlR.ascx"), ddlUserControlR)
    ...
    Private Sub CreateCalendar(ByVal name As String,
        ...
        'Crea instancia del control
        '----------------------------------------------
        Dim ucCalendar As cldUserControl = DirectCast(LoadControl(ucPath & "cldUserControl.ascx"), cldUserControl)
    ...
    Private Sub CreateRadioButton(
        ...
        'Crea instancia del control
        Dim ucRadioButton As rbUserControl = DirectCast(LoadControl(ucPath & "rbUserControl.ascx"), rbUserControl)
    ...
    Private Sub CreateCheckBoxButtom(
        ...
        'Crea instancia del control
        Dim ucCheckBox As chkButtomUserControl = DirectCast(LoadControl(ucPath & "chkButtomUserControl.ascx"), chkButtomUserControl)
    ...
    Private Sub CreateCheckBox(
        ...
        'Crea instancia del control
        Dim ucCheckBox As chkUserControl = DirectCast(LoadControl(ucPath & "chkUserControl.ascx"), chkUserControl)
            ...
            If PlaceHolder1 IsNot Nothing Then
                For Each Control As Control In PlaceHolder1.Controls
                    Select Case Control.TemplateControl.ToString
                        Case SessionID & "_txtusercontrol_ascx"
                        ...
                        Case SessionID & "_ddlusercontrol_ascx"
                        ...
                        Case SessionID & "_ddlusercontrolr_ascx"
                        ...
                        Case SessionID & "_cldusercontrol_ascx"
                            ...
                            Else
                                ...
                                End If
                            End If
                        Case SessionID & "_rbusercontrol_ascx"
                            ...
                            End If
                        Case SessionID & "_chkusercontrol_ascx"
                            ...
                            Select Case Session(i).ToString()
                                Case SessionID & "_txtusercontrol_ascx"
                                    ...
                                    If ucTextBox.ID.ToString = CambiaCampoFixed Then
                                        ...
                                        DirectCast(Session(i), txtUserControl).isFixed = False
                                    Else
                                ...
                                Case SessionID & "_ddlusercontrol_ascx"
                                    ...
                                    Exit Select
                                Case SessionID & "_ddlusercontrolr_ascx"
                                    Dim ucDropDownListR As ddlUserControlR = TryCast(LoadControl(ucPath & "ddlUserControlR.ascx"), ddlUserControlR)


                                    ucDropDownListR.DataValueType = DirectCast(Session(i), ddlUserControlR).DataValueType
                                    ucDropDownListR.ID = DirectCast(Session(i), ddlUserControlR).ID
                                    ucDropDownListR.SessionID = DirectCast(Session(i), ddlUserControlR).SessionID
                                    ucDropDownListR.source = DirectCast(Session(i), ddlUserControlR).source
                                    ucDropDownListR.DataTextField = DirectCast(Session(i), ddlUserControlR).DataTextField
                                    ucDropDownListR.DataValueField = DirectCast(Session(i), ddlUserControlR).DataValueField
                                    ucDropDownListR.Bind()
                                    ucDropDownListR.labelText = DirectCast(Session(i), ddlUserControlR).labelText

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucDropDownListR.ID.ToString = CambiaCampoFixed Then
                                        ucDropDownListR.isFixed = False
                                        DirectCast(Session(i), ddlUserControlR).isFixed = False
                                    Else
                                        ucDropDownListR.isFixed = DirectCast(Session(i), ddlUserControlR).isFixed
                                    End If

                                    ucDropDownListR.selectedValue = DirectCast(Session(i), ddlUserControlR).selectedValue
                                ...
                                Case SessionID & "_cldusercontrol_ascx"
                                    ...
                                    If ucCalendar.ID.ToString = CambiaCampoFixed Then
                                        ...
                                        DirectCast(Session(i), cldUserControl).isFixed = False
                                    Else
                                ...
                                Case SessionID & "_rbusercontrol_ascx"
                                    ...
                                    If ucRadioButton.ID.ToString = CambiaCampoFixed Then
                                        ...
                                        DirectCast(Session(i), rbUserControl).isFixed = False
                                    Else
                                    ...
                                    Exit Select
                                Case SessionID & "_chkusercontrol_ascx"
                                    Dim ucCheckList As chkUserControl = TryCast(LoadControl(ucPath & "chkUserControl.ascx"), chkUserControl)

                                    ucCheckList.ID = DirectCast(Session(i), chkUserControl).ID
                                    ucCheckList.SessionID = DirectCast(Session(i), chkUserControl).SessionID
                                    ucCheckList.source = DirectCast(Session(i), chkUserControl).source
                                    ucCheckList.DataValueField = DirectCast(Session(i), chkUserControl).DataValueField
                                    ucCheckList.DataTextField = DirectCast(Session(i), chkUserControl).DataTextField
                                    ucCheckList.bind()
                                    ucCheckList.labelText = DirectCast(Session(i), chkUserControl).labelText
                                    ucCheckList.DataValueType = DirectCast(Session(i), chkUserControl).DataValueType

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucCheckList.ID.ToString = CambiaCampoFixed Then
                                        ucCheckList.isFixed = False
                                        DirectCast(Session(i), chkUserControl).isFixed = False
                                    Else
                                        ucCheckList.isFixed = DirectCast(Session(i), chkUserControl).isFixed
                                    End If

                                    ucCheckList.selectedValue = DirectCast(Session(i), chkUserControl).selectedValue
                                ...
                                Case SessionID & "_chkbuttomusercontrol_ascx"
                                    Dim ucCheckList As chkButtomUserControl = TryCast(LoadControl(ucPath & "chkButtomUserControl.ascx"), chkButtomUserControl)

                                    ucCheckList.ID = DirectCast(Session(i), chkButtomUserControl).ID
                                    ucCheckList.SessionID = DirectCast(Session(i), chkButtomUserControl).SessionID
                                    ucCheckList.source = DirectCast(Session(i), chkButtomUserControl).source
                                    ucCheckList.DataValueField = DirectCast(Session(i), chkButtomUserControl).DataValueField
                                    ucCheckList.DataTextField = DirectCast(Session(i), chkButtomUserControl).DataTextField
                                    ucCheckList.bind()
                                    ucCheckList.labelText = DirectCast(Session(i), chkButtomUserControl).labelText
                                    ucCheckList.DataValueType = DirectCast(Session(i), chkButtomUserControl).DataValueType
                                    ucCheckList.isFixed = DirectCast(Session(i), chkButtomUserControl).isFixed
                                    ucCheckList.selectedValue = DirectCast(Session(i), chkButtomUserControl).selectedValue
    ...
    Private Sub CargaValoresFiltro()
        ...
        For Each _control As Control In PlaceHolder1.Controls
            Select Case _control.TemplateControl.ToString
                ...
                Case SessionID & "_txtusercontrol_ascx"
                    Dim ucTextBox As txtUserControl = TryCast(_control, txtUserControl)
                ...
                Case SessionID & "_rbusercontrol_ascx"
                    Dim ucRadioButton As rbUserControl = TryCast(_control, rbUserControl)
                    If _filtros.ContainsKey(ucRadioButton.labelText) Then
                        ucRadioButton.selectedValue = _filtros(ucRadioButton.labelText)
                    End If

                Case SessionID & "_chkusercontrol_ascx"
                    Dim ucCheckButton As chkUserControl = TryCast(_control, chkUserControl)
        ...
        Else
            ...
            For Each er As Entities.EtiquetaError In lstErrores
                If primero Then
                    ...
                    primero = False
                End If
                Me.Mensaje += er.Descripcion + "<br />"
            Next

            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Filtro incorrecto", String.Format("MuestraVerificacionFiltro('{0}');", Me.Mensaje), True)
        End If
        ...
        If TableRow2.Cells.Count > 0 Then
            ...
            If PlaceHolder1.Controls.Count = 1 Then
                ...
                Select Case tmpControl.TemplateControl.ToString()
                    Case SessionID & "_cldusercontrol_ascx"
                        Dim ucCalendar As cldUserControl = TryCast(PlaceHolder1.Controls(0), cldUserControl)
                        If ucCalendar.isFixed = False Then
                            ucCalendar.isFixed = True
                            CambiaCampoFixed = ucCalendar.ID.ToString()
                        End If
                    Case SessionID & "_rbusercontrol_ascx"
                        Dim ucRadioButton As rbUserControl = TryCast(PlaceHolder1.Controls(0), rbUserControl)
                        If ucRadioButton.isFixed = False Then
                            ucRadioButton.isFixed = True
                            CambiaCampoFixed = ucRadioButton.ID.ToString()
                        End If
                    Case SessionID & "_txtusercontrol_ascx"
                        Dim ucTextBox As txtUserControl = TryCast(PlaceHolder1.Controls(0), txtUserControl)
                        If ucTextBox.isFixed = False Then
                            ucTextBox.isFixed = True
                            CambiaCampoFixed = ucTextBox.ID.ToString()
                        End If
                    Case SessionID & "_ddlusercontrol_ascx"
                        Dim ucDDL As ddlUserControl = TryCast(PlaceHolder1.Controls(0), ddlUserControl)
                        If ucDDL.isFixed = False Then
                            ucDDL.isFixed = True
                            CambiaCampoFixed = ucDDL.ID.ToString()
                        End If
                    Case SessionID & "_ddlusercontrolr_ascx"
                        Dim ucDDL As ddlUserControlR = TryCast(PlaceHolder1.Controls(0), ddlUserControlR)
                        If ucDDL.isFixed = False Then
                            ucDDL.isFixed = True
                            CambiaCampoFixed = ucDDL.ID.ToString()
                        End If
                    Case SessionID & "_chkusercontrol_ascx"
                        Dim ucCheckBox As chkUserControl = TryCast(PlaceHolder1.Controls(0), chkUserControl)
...
''' </summary>
''' <remarks></remarks>
Friend Class CriterioSeleccion
