...
#End Region
    ...
    Public Sub ocultarBtnAgendar()
        ...
        If visita.IdPasoActual = 17 Then
            imgAgendar.Enabled = False
            imgAgendar.Visible = False
        End If
    ...
    Public Sub cargarDatosVisitaPrincipal(ByVal idVisita As Integer)
        ...
        If Not IsNothing(visita) Then
            ...
            If Not IsPostBack Then
                ...
                hfFolioSISAN.Value = visita.FolioSisan.Trim
            ...
            ''**************************************************************************************
            ucDocumentosVisita.ModificaIds(visita.IdVisitaGenerado)
            ucDoctosProrroga.ModificaIds(visita.IdVisitaGenerado)

            If Not IsNothing(ucDocumentosVisita.pObjPropiedades) And Not IsPostBack Then
                ucDocumentosVisita.pObjPropiedades = Nothing
            End If
            ...
            If IsNothing(ucDocumentosVisita.pObjPropiedades) Then
                ...
                Dim objPropiedades As New ucDocumentosVisita.PropiedadesDoc
                ...
                ucDocumentosVisita.pObjPropiedades = objPropiedades
                tpPestaniasDocsP.HeaderText = visita.NombreEntidad
            ...
            If (visita.IdPasoActual = 17) Then
                'pnlIrregularidadVista.Visible = True
                'AltaIrregularidad.Visible = True
                'AltaIrregularidad.Inicializar()
            ...
            Case "confirmarFechaInicioVisita"
                ...
                If AccesoBD.ActualizaFechaInicioVisita(visita.IdVisitaGenerado, ldFecIni, Constantes.TipoFecha.FechaInicio, ppObjVisita.SubVisitasSeleccionadas) Then
                    objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                            ...
                                                            True, Constantes.CORREO_FECHA_INICIO_VISITA, True, True, True, , , , , , , True,,, Constantes.MovimientoPaso.NotificaInicioVisita
                                                            )
                ...
                If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 Then
                    ...
                    If Not IsNothing(objUsuario) Then
                        ...
                        If AccesoBD.ActualizaFechaInicioVisita(visita.IdVisitaGenerado, ldFechaCampo, Constantes.TipoFecha.FechaCampoFinal, ppObjVisita.SubVisitasSeleccionadas) Then
                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                                             True, Constantes.EstatusPaso.Visita_Finalizada,
                                                                             True, visita.IdPasoActual, Constantes.EstatusPaso.Visita_Finalizada,
                                                                             False, -1,
                                                                             False, False, False, False, -1, -1, -1, -1, ldFechaCampo,,,, Constantes.MovimientoPaso.FinalizaVisitaINSITU
                                                                             )
                            ...
                            'Continua el cambia de paso a 7
                            ...
                            'ESTE MENSAJE SE ELIMA
                            'Me.Mensaje = "Debido a que ya no se realiza presentación de hallazgos con presidencia presiona el botón 'CONTINUAR' para seguir con el flujo de la visita"
                            'ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "PreguntaReunionVjPresidencia_V17();", True)
                            '' SE AGREGA MENSAJE


                            hdfPresentacionP6y7.Value = "Continuar"
    ...
    Protected Sub imgNotificar3_Click(sender As Object, e As ImageClickEventArgs) Handles imgNotificar3.Click
        If Not IsNothing(Session("DETALLE_VISITA_V17")) And Not IsNothing(Entities.Usuario.SessionID) Then
            ...
            If Not visita.IdPasoActual.Equals(5) Then
                If Not visita.IdPasoActual.Equals(12) Then
            ...
            If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
                ...
                Select Case visita.IdPasoActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                               ...
                                                               True, True, False, , , , , , , True,,, Constantes.MovimientoPaso.AprobacionDocumentosInicioVersionFinal
                                                               )
                                            Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                        End If
                                End Select
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            If Not IsNothing(Session("DETALLE_VISITA_V17")) And Not IsNothing(Entities.Usuario.SessionID) Then
                                                ...
                                                'If HayDocumentosObligatorios() Then Exit Sub
                                                'End If
                                                If ValidacionDeDocumentosPaso5() = True Then
                                                    ...
                                                    Exit Sub
                                                End If
                                                Dim visitas As New Visita()
                                                visitas = CType(Session("DETALLE_VISITA_V17"), Visita)

                                                Dim Usuarios As New Entities.Usuario()
                                                Usuarios = Session(Entities.Usuario.SessionID)
                    ...
                    Case 8
                        ...
                        ''DEL PASO ACTUAL 10 AL PASO NUEVO 9
                    Case 9
                        Select Case visita.IdEstatusActual
                                        ...
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            If visita.ExisteReunionPaso8 Then
                                                ...
                                                If Fechas.Vacia(visita.FECH_REUNION__PRESIDENCIA) Then
                                                    ...
                                                    If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 9, ppObjVisita.IdArea) Then ''paso actual 10 al 9 que es el nuevo paso
                                                        AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 9, Constantes.Parametros.fechaMinima)
                                                    End If
                                                ...
                                                Else
                                                    'SI LA FECHA YA SE INGRESÓ, SE ACTUALIZA EN ESTIMADAS    
                                                    If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 9, ppObjVisita.IdArea) Then ''Revisar paso actual 10 al 9 que es el nuevo paso
                                                        AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 9, Constantes.Parametros.fechaMinima)
                                                    End If
                                                    ...
                                                    Me.Mensaje = "¿Se llevó a cabo la reunión opcional 9.1 - Retroalimentación de Acta Circunstanciada?" + AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 9) +
                        ...
                        ''Se coomento el paso 11 ya que se sustituyo por el 13
                    'Case 11
...
''SE CAMBIA DEL CASO 12 AL 10 DEL NUEVO PASO
                    Case 10
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.Hallazgos_presentados
                                ...
                                End Select
                        End Select
''DEL PASO ACTUAL 13 AL PASO NUEVO 11
                    Case 11
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.Registrado ''Solicitar fecha acta circunstanciada in situ
                                ...
                                End Select
                        End Select
''DEL PASO ACTUAL 14 AL PASO NUEVO 12
                    Case 12
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.EnRevisionEspera
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            If Not IsNothing(Session("DETALLE_VISITA_V17")) And Not IsNothing(Entities.Usuario.SessionID) Then
                                                ...
                                                ''Valida si hay documentos obligatorios sin cargar
                                                If ValidacionDeDocumentosPaso5() = True Then
                                                    Me.Mensaje = "¿Existe respuesta del AFORE?"
                                                ...
                                                Else
                                                    ...
                                                    If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
                                                        Dim objNegVisitas As New NegocioVisita(visita, Usuario, Server, txbComentarios.Text)
                                                        ...
                                                        End If
                                                        ''se implemte ScriptManager para PUNTO 13.1

                                                        'Avanza a paso 15
                                                        '
                                                        'objNegVisitas.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnRevisionEspera,
                                                        '                  True, Constantes.EstatusPaso.EnRevisionEspera,
                                                        '                  True, (visita.IdPasoActual + 1), Constantes.EstatusPaso.EnRevisionEspera,
                                                        '                  True, idCorreoAforeResponde,,,,,,,,,,,,, Constantes.MovimientoPaso.ValidaRespuestaAFORE
                                                        '                  )
                                                    End If
                                                End If
                                                ...
                                                'End If
                                                'End If
                                                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitaFechaRevHallazgosP13();", True)
                                                'Response.Redirect("../Procesos/DetalleVisita_V17.aspx")

                                            End If
                                            'SE PREGUNTA ¿Hubo respuesta de la AFORE al Acta circunstanciada?

                                            ''COMENTAMOS ESTE PASO GP
                    ...
                    Case 15
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.Revisado ''Flujo inicial paso 18, Revisado
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP 'Solo el Supervisor / Superior  puede:  *Notificar 
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            lblFechaActaCirc.Text = AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 15)

                                            Mensaje = Constantes.MensajesModal.ConfirmaFechaRetroActaC + ":" + lblFechaActaCirc.Text +
                                                "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                                            "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                                            "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                                ...
                                End Select
                        End Select
''DEL PASO ACTUAL 19 AL PASO NUEVO 16
                    Case 16
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.Revisado
                                ...
                                End Select
                        End Select
                        'se comenta por que se pasa a botón de enviar 
            ...
            If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
                ...
                Select Case visita.IdPasoActual
                                ...
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            If ucDocumentosVisita.ConsultaDocumentosObligatoriosSinCargarPorPasoUsuario(PasoProcesoVisita.Pasos.Uno, Constantes.Obligatorio.Obligatorios, visita.IdVisitaGenerado) Then
                                            ...
                                            Else
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                                                                      ...
                                                                                                      Constantes.MovimientoPaso.EnviaDocumentacionInicial
                                                                                                      )
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                                                                        ...
                                                                                                        True, True, False, , , , , , , True,,, Constantes.MovimientoPaso.AprobacionDocumentosInicio
                                                                                                        )
                                        End Select
                                End Select
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Aprobado,
                                                                                                          False, -1,
                                                                                                          True, visita.IdPasoActual, Constantes.EstatusPaso.Aprobado,
                                                                                                          True, Constantes.CORREO_ID_NOTIFICA_AREA_REGISTRO_VISITA_APROBADO,
                                                                                                          True, True, False,
                                                                                                          True, Constantes.TipoReactivacion.FinalizaReactivacion,
                                                                                                          (visita.IdPasoActual + 1), visita.IdPasoActual,
                                                                                                          Constantes.EstatusPaso.EnRevisionEspera, , True,,, Constantes.MovimientoPaso.AprobacionDocumentosInicio
                                                                                                          )
                                        End Select
                                End Select
                        End Select
                  ...
                  'O BIEN SI FINALIZA EL PASO 7 POR SEPARADO DEL PASO 6
                    ...
                    '            End Select
                    '    End Selecta
                  ''ESTE VA HACER EL PASO 7 ANTES ERA EL 8
                    Case 7
                        Select Case visita.IdEstatusActual
                                ...
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP  'Solo el supervisor/superior puede:  *Notificar 
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            lblDscFechaPaso.Text = "Elegir fecha tentativa de la reunión  9.1 de revisión de acta circunstanciada con el área jurídica:"
                                            dvRdo.Visible = True
                            ...
                            Case Constantes.EstatusPaso.AjustesRealizados
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP  'envia al paso 10
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            txtFechaGeneral.Text = Fechas.Valor(visita.Fecha_ReunionVjPaso9)
                                            lblDscFechaPaso.Visible = True
                                            lblDscFechaPaso.Text = "Elegir fecha tentativa de la reunión opcional de revisión de acta circunstanciada con el área jurídica:"
                                            dvRdo.Visible = True
                                            lblInfoValFechaIngresada.Visible = True
                                            lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 4 días hábiles a partir de hoy."
                                            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitarFechaReunPreciJuridico();", True)
                                ...
                                End Select
                        End Select
                        ''ESTE VA HACER EL PASO 8 ANTES ERA EL 9
                    Case 8
                        ...
                        Select Case visita.IdEstatusActual
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                ElseIf visita.TieneSancion Then
                                                    ...
                                                    Else
                                                        fechaP9 = AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 8)
                                                    End If
                                                    'SE Correcion 9.1 a 8.1
                                                    Me.Mensaje = "La fecha de la reunión  8.1 – Revisión de Acta Circunstanciada con el área de Supervisión fue:  " & fechaP9 & "." +
                                                        "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                                        "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                                        "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                                                    lblFechaActaCirc.Visible = False
                            ...
                            Case Constantes.EstatusPaso.AjustesRealizados
                                ...
                                End Select
                        End Select
 ''ESTE VA HACER EL PASO 9 ANTES ERA EL 10
                    Case 9 'MCS
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.Revisado
                                Select Case Usuario.IdentificadorPerfilActual
                            ...
                            Case Constantes.EstatusPaso.AjustesRealizados
                                ...
                                End Select
                        End Select
                 ''SE CAMBIO DEL PASO ACTUAL 15 AL NEW NUMERO 13
                    Case 13
                        Select Case visita.IdEstatusActual
                                ...
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            '     If visita.ExisteReunionPaso8 Then
                                            '         lblFechaActaCirc.Visible = False
                                            '         lblFechaActaCirc.Text = AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 13)
                                            '         txtFechaGeneral.Text = AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 13)
                                            ...
                                            ''OJO ME FALTA CONSULTAR DE LA BASE DE DATOS LA FECHA
                                            'If txtFechaGeneral.Text = Fechas.Valor(visita.Fecha_ReunionVjPaso16) Then
                                            lblFechaActaCirc.Visible = False
                                            lblFechaActaCirc.Text = AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 13)
                                            txtFechaGeneral.Text = AccesoBD.getFechaEstimadaPorPaso(visita.IdVisitaGenerado, 13)
                                            ...
                                            'lblDscFechaPaso.Visible = True
                                            'lblDscFechaPaso.Text = "¿En qué fecha será la reunión 13.1.- Revisión de acta de conclusión   con la Vicepresidencia Jurídica?"
                                            'dvRdo.Visible = True
                                            'lblInfoValFechaIngresada.Visible = True
                                            'lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 4 días hábiles a partir de hoy."
                                            Me.Mensaje = Constantes.MensajesModal.FechaReunionResAfore + ":" + lblFechaActaCirc.Text +
                                                           "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                                           "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                                           "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                                            'txtFechaGeneral.Text = Fechas.Valor(visita.Fecha_ReunionVjPaso16)

                                            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "ConfirmarFechaReunP13();", True)
                                            Exit Sub
                                            'End If
                                        End If
                                End Select
                            Case Constantes.EstatusPaso.AjustesRealizados ''Flujo 2 paso 16, AjustesRealizados
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP 'Vuelve a mandar a paso 17
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            'lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 4 días hábiles a partir de hoy."
                                            'ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "ConfirmarFechaReunP13();", True)
                                            Me.Mensaje = Constantes.MensajesModal.FechaReunionResAfore + ":" & txtFechaGeneral.Text &
                                                       "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                                       "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                                       "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                                ...
                                End Select
                        End Select
''ESTE VA HACER EL PASO 16 ANTES ERA EL 14
                    Case 14
                        Select Case visita.IdEstatusActual
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                                         True, Constantes.EstatusPaso.Aprobado,
                                                                         True, (visita.IdPasoActual + 1), Constantes.EstatusPaso.EnRevisionEspera,
                                                                         False, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CONCLUSION, True, True, , , , , , , , True,,, Constantes.MovimientoPaso.ApruebaActaConclusion
                                                                         )

                                                ''Si es supervisor solicitar confirmar fecha con VJ
                                                If Not visita.SolicitoFechaPaso16 Then
                                                    Mensaje = "La fecha de la reunión 14.1 - Revisar Acta de conclusión con el área de Supervisión fue: " & visita.Fecha_ReunionVjPaso16.ToString("dd/MM/yyyy") & "." +
                                                            "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                                            "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                                            "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                                                    txtFechaGeneral.Text = Fechas.Valor(visita.Fecha_ReunionVjPaso16)
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AjustesEnviados,
                                                                                                          False, -1,
                                                                                                          True, visita.IdPasoActual, Constantes.EstatusPaso.AjustesEnviados,
                                                                                                          True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CONCLUSION,
                                                                                                          True, True, False,
                                                                                                          True, Constantes.TipoReactivacion.FinalizaReactivacion,
                                                                                                          (visita.IdPasoActual + 2), visita.IdPasoActual,
                                                                                                          Constantes.EstatusPaso.EnRevisionEspera, , True,,, Constantes.MovimientoPaso.ApruebaActaConclusion
                                                                                                          )
                                                ''Si es supervisor solicitar confirmar fecha con VJ
                                                If Not visita.SolicitoFechaPaso16 Then
                                                    Mensaje = "La fecha de la reunión 16.1 - Revisar Acta de conclusión con el área de Supervisión fue: " & visita.Fecha_ReunionVjPaso16.ToString("dd/MM/yyyy") & "." +
                                                            "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                                            "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                                            "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                                                    txtFechaGeneral.Text = Fechas.Valor(visita.Fecha_ReunionVjPaso16)
                                ...
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP ''Paso 20 manda a paso 21
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "MostrarMensajeConfirmacion();", True)
        ...
        If Not IsNothing(Session("DETALLE_VISITA_V17")) And Not IsNothing(Entities.Usuario.SessionID) Then
            ...
            If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
                ...
                Select Case visita.IdPasoActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS ''Atiende observaciones VJ
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AjustesEnviados,
                                                                                                    ...
                                                                                                    True, Constantes.CORREO_ATIENDE_AJUSTES,
                                                                                                    True, False, False,,,,,,,,,,
                                                                                                    Constantes.MovimientoPaso.CargaDocumentacionInicial
                                                                                                    )
                                        End If
                                End Select
                        End Select
                                                    ...
                                                    If AccesoBD.ActualizaResponsablesVisita(visita.IdVisitaGenerado, lsAboSup, Constantes.ResponsablesVisita.AbogadoSupAsesor, Constantes.OPERCION.Insertar) Then
                                                        If AccesoBD.ActualizaResponsablesVisita(visita.IdVisitaGenerado, lsAboOp, Constantes.ResponsablesVisita.Asesor, Constantes.OPERCION.Insertar) Then
                                                            ...
                                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.SupervisorAsignado,
                                                                                                            False, -1,
                                                                                                            True, visita.IdPasoActual, Constantes.EstatusPaso.SupervisorAsignado,
                                                                                                            True, Constantes.CORREO_NOTIFICA_ABOGADO_ASESOR,
                                                                                                            True, True, False, , , , , , , True,,, Constantes.MovimientoPaso.AsignaAbogadoSupervisor
                                                                                                            )
                                                        End If
                                                    End If
                                                End If
                                                ...
                                                Else
                                                    If AccesoBD.ActualizaResponsablesVisita(visita.IdVisitaGenerado, lsAboOp, Constantes.ResponsablesVisita.Asesor, IIf(visita.LstAbogadosAsesorAsignados.Count > 0, Constantes.OPERCION.Actualizar, Constantes.OPERCION.Insertar)) Then
                                                        ...
                                                        objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AsesorAsignado,
                                                                                                        False, -1,
                                                                                                        True, visita.IdPasoActual, Constantes.EstatusPaso.AsesorAsignado,
                                                                                                        True, Constantes.CORREO_NOTIFICA_ABOGADO_ASESOR,
                                                                                                        True, True, False, , , , , , , True,,, Constantes.MovimientoPaso.AsignaAbogadoAsesor
                                                                                                        )
                                                    End If
                                                End If
                                        End Select
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                                        False, -1,
                                                                                                        True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                                        True, Constantes.CORREO_REVISION_DOCUMENTOS,
                                                                                                        False, True, False,,,,,,,,,, Constantes.MovimientoPaso.RevisaDocumentosInicio
                                                                                                        )
                                        End Select
                                End Select
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                                    False, -1,
                                                                                                    True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                                    False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.RevisaComentariosDocumentosInicio
                                                                                                    )
                                        End If
                                End Select
                        End Select
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                                    False, -1,
                                                                                                    True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                                    False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.CargaPDFDocumentosInicio
                                                                                                    )
                                        End If
                                End Select
                        End Select
                  ...
                  ''Pasar A la numeracion de 8 a 7 GP
                    Case 7
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.EnRevisionEspera
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_INS, Constantes.PERFIL_SUP 'Solo el inspector puede:  *adjuntar documentos (acta circunstnaciada) 
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Elaborada,
                                                                                                    False, -1,
                                                                                                    True, visita.IdPasoActual, Constantes.EstatusPaso.Elaborada,
                                                                                                    True, Constantes.CORREO_ID_NOTIFICA_SUPERVISOR_ACTA_CIRCUNSTANCIADA_MODIFICADA,
                                                                                                    True, False, False, , , , , , , True,,, Constantes.MovimientoPaso.GeneraActaCircunstanciada
                                                                                                    )
                                        End If
                                End Select
                            Case Constantes.EstatusPaso.EnAjustes
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_INS, Constantes.PERFIL_SUP 'adjuntar los documentos
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AjustesRealizados,
                                                                                                               False, -1,
                                                                                                               True, visita.IdPasoActual, Constantes.EstatusPaso.AjustesRealizados,
                                                                                                    True, Constantes.CORREO_ID_NOTIFICA_SUPERVISOR_ACTA_CIRCUNSTANCIADA_MODIFICADA,
                                                                                                    True, False, False, , , , , , , True,,, Constantes.MovimientoPaso.GeneraActaCircunstanciada
                                                                                                    )
                                        End If
                                End Select
                        End Select
                         ''Pasar A la numeracion de 9 a 8 GP
                    Case 8
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                                          ...
                                                                                                          False, True, False, , , , , , , True,,, Constantes.MovimientoPaso.RevisaActaCircunstanciada
                                                                                                          )
                                        End Select
                                End Select
                       ...
                       ''Pasar A la numeracion de 12 a 10 GP
                    Case 10
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.EnRevisionEspera
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS ''adjunta documentos del paso 12
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Hallazgos_presentados,
                                                                                                      False, -1,
                                                                                                      True, visita.IdPasoActual, Constantes.EstatusPaso.Hallazgos_presentados,
                                                                                                      False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.CargaPresentacionInterna
                                                                                                      )
                                        End If
                                End Select
                        End Select
                        'Pasar A la numeracion de 13 a 11 GP
                    Case 11
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.EnRevisionEspera
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_INS, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Registrado,
                                                                     False, -1,
                                                                     True, visita.IdPasoActual, Constantes.EstatusPaso.Registrado,
                                                                     False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.CargaPDFActaCircunstanciada
                                                                     )
                                        End If
                                End Select
                        End Select
             ''SE MODIFICA DEL PASO 15 ACTUAL AL 13 DE NEW NUMERACION
                    Case 13
                        Select Case visita.IdEstatusActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_INS, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                ...
                                                                                True, False, False, , , , , , , True,,, Constantes.MovimientoPaso.GeneraActaConclusion
                                                                                )
                                        End If
                                End Select
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AjustesRealizados,
                                                                                False, -1,
                                                                                True, visita.IdPasoActual, Constantes.EstatusPaso.AjustesRealizados,
                                                                                False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.GeneraActaConclusion
                                                                                )
                                        End If
                                End Select
                        End Select
                        'Pasar A la numeracion de 16 a 14 GP
                    Case 14
                        Select Case visita.IdEstatusActual
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                    False, -1,
                                                                                    True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                    False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.RevisaActaConclusion
                                                                                    )
                                        End Select
                                End Select
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, visita.IdEstatusActual,
                                                                                    False, -1,
                                                                                    True, visita.IdPasoActual, visita.IdEstatusActual,
                                                                                    False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.RevisaActaConclusion)
                                        End Select
                                End Select
                        End Select
                    ...
                    'Case 17
                    '    Dim irregularidadesRegistradas As DataTable = Entities.IrregularidadVisita.ObtenerTodas(visita.IdVisitaGenerado)
                    '    If irregularidadesRegistradas.Rows.Count > 0 Then
                    '        imgSiguiente.Visible = True
                    '        imgSiguiente.Enabled = True
                    '    Else
                    '        Mensaje = "Es necesario agregar al menos una irregularidad"
                    '        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "MostrarMensajeError();", True)
                    '    End If
       'Pasar A la numeracion de 18 a 15 GP
                    Case 15
                        Select Case visita.IdEstatusActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                False, -1,
                                                                                True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.RevisaComentariosActaConclusion
                                                                                )
                                        End If
                                End Select
                        End Select
'Pasar A la numeracion de 19 a 16 GP
                    Case 16
                        Select Case visita.IdEstatusActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                False, -1,
                                                                                True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.CargaPDFActaConclusión
                                                                                )
                                        End If
                                End Select
                        End Select
'Pasar A la numeracion de 20 a 17 GP
                    Case 17 'este es la misma funcionalidad del paso 19 del proceso anterior de copia y pega AMMM 25/09/2018
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.EnRevisionEspera ''Paso 19 guardar comentarios
                                Select Case Usuario.IdentificadorPerfilActual
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            Dim irregularidadesRegistradas As DataTable = Entities.IrregularidadVisita.ObtenerTodas(visita.IdVisitaGenerado)
                                            If irregularidadesRegistradas.Rows.Count > 0 Then
                                                'segmento de código para habilitar btn Siguiente
                                                'imgSiguiente.Visible = True
                                                'imgSiguiente.Enabled = True

                                                Dim conexionC As New Conexion.SQLServer()
                                                Dim query As String = "SELECT * FROM BDS_D_VS_DOCUMENTO_PASO WHERE I_ID_VISITA=" & visita.IdVisitaGenerado & " AND N_ID_DOCUMENTO=" & 37
                                                Dim dtDictamen As DataTable = conexionC.ConsultarDT(query)
                                                conexionC.CerrarConexion()
                                                If dtDictamen.Rows.Count > 0 Then
                                                    'Dim EstatusDocumentoDictamen = IIf(IsDBNull(dtDictamen.Rows(0)("T_ID_ESTATUS_DOC")), 0, dtDictamen.Rows(0)("T_ID_ESTATUS_DOC"))
                                                    If ConexionSICOD.FolioFinalizado(dtDictamen.Rows(0)("T_FOLIO_SICOD")) Then
                                                        'End If
                                                        'If Not IsNothing(EstatusDocumentoDictamen) And EstatusDocumentoDictamen = 6 Then
                                                        objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Revisado,
                                                                                                  False, -1,
                                                                                                  True, visita.IdPasoActual, Constantes.EstatusPaso.Revisado,
                                                                                                  False, -1,,,,,,,,,,,,, Constantes.MovimientoPaso.CompletarDatosSISAN
                                                                                                  )
                                                        Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                                        'imgSiguiente.Visible = True
                                                        'imgSiguiente.Enabled = True
                                                    Else
                                                        Mensaje = "El documento de dictamen no tiene un estatus concluido."
                                                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "MostrarMensajeError();", True)
                                                    End If
                                                Else
                                                    Mensaje = "No se ha registrado un documento de dictamen."
                                                    ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "MostrarMensajeError();", True)
                                                End If
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP 'Regresa a paso 1
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnAjustes,
                                                                                                          False, -1,
                                                                                                          True, visita.IdPasoActual, Constantes.EstatusPaso.EnAjustes,
                                                                                                          True, Constantes.CORREO_ID_NOTIFICA_AREA_REGISTRO_VISITA_RECHAZADO,
                                                                                                          True, True, False,
                                                                                                          True, Constantes.TipoReactivacion.Reactivado,
                                                                                                          visita.IdPasoActual, (visita.IdPasoActual - 1),
                                                                                                          Constantes.EstatusPaso.EnAjustes, , True,,, Constantes.MovimientoPaso.RechazaDocumentosInicio
                                                                                                          )
                                                Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                        End Select
                                End Select
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnAjustes,
                                                                                                    ...
                                                                                                    True, Constantes.TipoReactivacion.Reactivado,
                                                                                                    visita.IdPasoActual, (visita.IdPasoActual - 1),
                                                                                                    Constantes.EstatusPaso.EnAjustes, , True,,, Constantes.MovimientoPaso.RechazaComentariosDocumentosInicio
                                                                                                    )
                                            Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                        End If
                                End Select
                        End Select
'' EL PASO ACTUAL ERA 9 Y EL NUEVO ES 8
                    Case 8
                        Select Case visita.IdEstatusActual
                            Case Constantes.EstatusPaso.Revisado
                                Select Case Usuario.IdentificadorPerfilActual
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnAjustes,
                                                                                                          ...
                                                                                                          True, Constantes.TipoReactivacion.Reactivado,
                                                                                                          visita.IdPasoActual, (visita.IdPasoActual - 1),
                                                                                                          Constantes.EstatusPaso.EnAjustes, , True,,, Constantes.MovimientoPaso.RechazaActaCircunstanciada
                                                                                                          )
                                                Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                        End Select
                                End Select
                            Case Constantes.EstatusPaso.AjustesRealizados
                                ...
                                End Select
                        End Select
'' EL PASO ACTUAL ERA 10 Y EL NUEVO ES 9
                    Case 9
                        Select Case visita.IdEstatusActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS   'Supervisor avisa de la version final de los documentos
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnAjustes,
                                                                                                      ...
                                                                                                      True, Constantes.TipoReactivacion.Reactivado,
                                                                                                      visita.IdPasoActual, (visita.IdPasoActual - 1),
                                                                                                      Constantes.EstatusPaso.EnAjustes, , True,,, Constantes.MovimientoPaso.RechazaComentariosActaCircunstanciada
                                                                                                      )
                                            Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                        End If
                                End Select
                        End Select
'' EL PASO ACTUAL ERA 16 Y EL NUEVO ES 14
                    Case 14
                        Select Case visita.IdEstatusActual
                                        ...
                                        Select Case Usuario.IdArea
                                            Case Constantes.AREA_PR, Constantes.AREA_VJ
                                                ...
                                                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnAjustes,
                                                                                                          ...
                                                                                                          True, Constantes.TipoReactivacion.Reactivado,
                                                                                                          visita.IdPasoActual, (visita.IdPasoActual - 1),
                                                                                                          Constantes.EstatusPaso.EnAjustes,,,,, Constantes.MovimientoPaso.RechazaActaConclusion
                                                                                                          )
                                                Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
                                        End Select
                                End Select
                            Case Constantes.EstatusPaso.AjustesRealizados  ''Flujo 2 paso 17 regresa paso 16, AjustesRealizados
                                ...
                                End Select
                        End Select
                        '' EL PASO ACTUAL ERA 18 Y EL NUEVO ES 15
                    Case 15
                        Select Case visita.IdEstatusActual
                                    ...
                                    Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                        If EsAreaOperativa(Usuario.IdArea) Then
                                            ...
                                            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnAjustes,
                                                                                                      ...
                                                                                                      True, Constantes.TipoReactivacion.Reactivado,
                                                                                                      visita.IdPasoActual, (visita.IdPasoActual - 1),
                                                                                                      Constantes.EstatusPaso.EnAjustes, , True,,, Constantes.MovimientoPaso.RechazaComentariosActaConclusion
                                                                                                      )
    ...
    Protected Sub imgIniciarVisita_Click(sender As Object, e As ImageClickEventArgs) Handles imgIniciarVisita.Click
        If Not IsNothing(Session("DETALLE_VISITA_V17")) And Not IsNothing(Entities.Usuario.SessionID) Then
            ...
            If Session("RESPONDIO_AFORE") = "AforeSi" Then
                ''Valida si hay documentos obligatorios sin cargar
                If ValidacionDeDocumentosPaso5() Then
                    'Response.Redirect("../Procesos/DetalleVisita_V17.aspx#tab3")
    ...
    Private Sub SolicitarRespuestaP14()
        If Not IsNothing(Session("DETALLE_VISITA_V17")) And Not IsNothing(Entities.Usuario.SessionID) Then
    ...
    Protected Sub btnFechaCampo_Click(sender As Object, e As EventArgs) ''Paso 6 inicia visita
        ...
        If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
            ...
            'Lo traje funcion del confirmapasocinco si y no hay respuesta
            If Session("RESPONDIO_AFORE") = "AforeSi" Then
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnRevisionEspera,
                                                             True, Constantes.EstatusPaso.EnRevisionEspera,
                                                             True, 6, Constantes.EstatusPaso.EnRevisionEspera,
                                                             True, Constantes.CORREO_ID_NOTIFICA_SI_RESPUESTA_AFORE_OFICIOS_INICIO,,,,,,,,,,,,, Constantes.MovimientoPaso.ValidaResultadoAFOREeIniciaINSITU
                                                             )
            Else
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnRevisionEspera,
                                                     True, Constantes.EstatusPaso.EnRevisionEspera,
                                                     True, 6, Constantes.EstatusPaso.EnRevisionEspera,
                                                     True, Constantes.CORREO_ID_NOTIFICA_NO_RESPUESTA_AFORE_OFICIOS_INICIO,,,,,,,,,,,,, Constantes.MovimientoPaso.ValidaResultadoAFOREeIniciaINSITU
                                                     )
            End If
    ...
    Protected Sub btnFechaRevHallazgos_V17_SC_Click(sender As Object, e As EventArgs) Handles btnFechaRevHallazgos_V17_SC.Click
        ...
        If ppObjVisita.TieneSancion Then
            Me.Mensaje = "La fecha de la reunión 7.1 - Revisión de presentación de hallazgos con el área de Supervisión fue: " & ppObjVisita.Fecha_ReunionVjPaso9.ToString("dd/MM/yyyy") & "." +
                "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
            lblFechaActaCirc.Visible = False
    ...
    End Sub
    ''Se IMPLEMENTA NUEVO BUTTON PARA EL PASO 13.1 GP BORRAR CUANDO ESTE BIEN
    'btnFechaRevHallazgosp13 CONFIRMACION
    Protected Sub btnFechaRevHallazgosp13_Click(sender As Object, e As EventArgs) Handles btnFechaRevHallazgosp13.Click
        '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''2 PROCESOS DE PRUEBA''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ''Validar que este llena y sea correcta la fecha de campo
        Dim lsFecha As String = txtFechRevHallazgoss.Text.Trim()
        Dim ldFechaCampo As DateTime
        ...
        If Convert.ToDateTime(lsFecha) > fechaConvoca.Date Then
            lblPresentaHallazgoss.Text = "La fecha ingresada no puede ser mayor a la fecha actual más cuatro días hábiles."
            lblPresentaHallazgoss.Visible = True
            Image18.ImageUrl = Constantes.Imagenes.Fallo
            txtFechRevHallazgoss.Text = ""
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitaFechaRevHallazgosP13();", True)
            Exit Sub
        End If
        '//
        ...
        ''Regresa DateTime.MinValue si alguna validacion falla
        ldFechaCampo = ValidarFechaGeneral(lsFecha, lblPresentaHallazgoss, Image18, "SolicitaFechaRevHallazgosP13();", False, False, True)
        If ldFechaCampo = DateTime.MinValue Then
            Exit Sub
        End If
        ...
        If Not AccesoBD.ExisteVisitaConFechaEstimada(visita.IdVisitaGenerado, 13, visita.IdArea) Then
            AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(visita.IdVisitaGenerado, 13, visita.IdArea, 0, lsFecha)
        Else
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 13, lsFecha)
        End If

        If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
            Dim objNegVisita As New NegocioVisita(visita, Usuario, Server, txbComentarios.Text)

            'Colocar aquí el método para cambiar de paso
            Dim idCorreoAforeResponde As Integer = 0
            'NOTIFICAR HUBO SI O NO RESPUESTA POR PARTE DE LA AFORE Y AVANZA DE PASO
            If Session("RESPONDIO_AFORE_P14") = "AforeSiP14" Then
                idCorreoAforeResponde = Constantes.CORREO_ID_NOTIFICA_SI_RESPUESTA_AFORE_OFICIOS_INICIO
            ...
            'Validar el flujo que se tomo para actualizar al siguiente  paso
            If hfFlujoActualPaso.Value.Equals("13") Then
                If hdfPresentacionP6y7.Value.Equals("SI") Then
                    objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                                                                   ...
                                                                   False, -1)
                Else   ''SE MODIFICA EL PASO 15 AL 13
                    objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                                                                   True, Constantes.EstatusPaso.Hallazgos_presentados_notificado,
                                                                   True, 13, Constantes.EstatusPaso.EnRevisionEspera,
                                                                   False, -1)
            ...
            EnviarConvocatoriaReunion(Convert.ToDateTime(txtFechRevHallazgoss.Text).ToString("yyyy/MM/dd"), "10:00:000", ObtenerListaInvolucradosVisita(), "Por Definir", 600, AccesoBD.ObtenerAsuntoConvocatoria(Constantes.AsuntoCorreo.Paso8).Replace("[Folio visita]", ppObjVisita.FolioVisita))

            ''COMENTO ESTE CODIGO PARA HACER PRUEBAS
            'Me.Mensaje = "¿Habrá Sanción para la Visita?"
            'ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "PreguntarSancionPasoSiete();", True)

            'HABILITO ESTE CODIGO COMENTADO
            Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
            Exit Sub
        ...
        'If ppObjVisita.TieneSancion Then
        '    Me.Mensaje = "La reunión 13.1 para revisar la respuesta de la AFORE con VJ se llevó a cabo en la fecha: " & ppObjVisita.Fecha_ReunionVjPaso9.ToString("dd/MM/yyyy") & "." +
        '     "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
        '     "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
        '     "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
        '    lblFechaActaCirc.Visible = False
        ...
        '    EnviarConvocatoriaReunion(Convert.ToDateTime(txtFechRevHallazgos.Text).ToString("yyyy/MM/dd"), "10:00:000", ObtenerListaInvolucradosVisita(), "Por Definir", 600, AccesoBD.ObtenerAsuntoConvocatoria(Constantes.AsuntoCorreo.Paso12).Replace("[Folio visita]", ppObjVisita.FolioVisita))
        ...
        'End If
    End Sub
    ''EJEMPLO 13.1 PEDIR FECHA REUNION
    ...
    Protected Sub btnFechaRevHallazgos_Click(sender As Object, e As EventArgs) Handles btnFechaRevHallazgos.Click
        ...
        'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
        If Not AccesoBD.ExisteVisitaConFechaEstimada(visita.IdVisitaGenerado, 7, visita.IdArea) Then
            AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(visita.IdVisitaGenerado, 7, visita.IdArea, 0, lsFecha)
        Else
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 7, lsFecha)
        End If
            ...
            If piBanderaModificacio = 0 Then
                ...
                If AccesoBD.ActualizaFechaInicioVisita(visita.IdVisitaGenerado, ldFechaReunion, Constantes.TipoFecha.FechaReunionPresi, ppObjVisita.SubVisitasSeleccionadas) Then
                    objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.EnEsperaPresentarHallazgos,
                                                                            ...
                                                                            True, True, True, , , , , , , True,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada) '',,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada
                End If
            ...
            If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
                ...
                If AccesoBD.ActualizarRangoSancion(visita.IdVisitaGenerado, rango1, rango2, txtRango.Text.Trim(), ppObjVisita.SubVisitasSeleccionadas) Then
                    ...
                    If Not visita.SolicitoFechaPaso9 Then
                        Mensaje = "La fecha de la reunión 9.1 – Revisión de Acta Circunstanciada con el área de Supervisión fue:  " & visita.Fecha_ReunionVjPaso9.ToString("dd/MM/yyyy") & "." +
                            "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                            "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                            "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
                        lblFechaActaCirc.Visible = False
                ...
                Else
                    ...
                    Else
                        ...
                        If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
                            ...
                            txtFechaGeneral.Text = ""
                            lblDscFechaPaso.Visible = True
                            lblDscFechaPaso.Text = "¿En qué fecha será la reunión 18.1.- Retroalimentación de comentarios a acta de conclusión?"
                            dvRdo.Visible = True
                            lblInfoValFechaIngresada.Visible = True
                            lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 3 días hábiles a partir de hoy."
            ...
            If AccesoBD.ActualizaFechaInicioVisita(visita.IdVisitaGenerado, ldFecha, Constantes.TipoFecha.FechaReunionAfore, ppObjVisita.SubVisitasSeleccionadas) Then
                ...
                If piBanderaModificacio = 0 Then
                    objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.Notificado,
                                                                            False, -1,
                                                                            True, visita.IdPasoActual, Constantes.EstatusPaso.Notificado,
                                                                            True, Constantes.CORREO_PRESENTACION_DIAGNOSTICO_HALLAZGOS,
                                                                            True, True, True, , , , , , , True,,, Constantes.MovimientoPaso.ConfirmaFechaPresentacion
                                                                            )
                Else
                    Dim objCorreo As New Entities.Correo(Constantes.CORREO_CAMBIO_FECHA_EXTERNA_INTERNA)
    ...
    Private Sub cargaPestaniasSubVisitas(pObjVisita As Visita, pbPermisosDoctos As Boolean)
        ...
        Dim lcuDocumentos As ucDocumentosVisita
        Dim lAuxVisita As Visita
        Dim objPropiedades As ucDocumentosVisita.PropiedadesDoc
        ...
        For Each lObjSubVisita As Visita.SubVisitas In pObjVisita.LstSubVisitas
            ...
            lcuDocumentos = CType(LoadControl("../Controles/ucDocumentosVisita.ascx"), ucDocumentosVisita)
            ...
            objPropiedades = New ucDocumentosVisita.PropiedadesDoc
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function ValidacionDeDocumentosPaso5() As Boolean
        'If ucDocumentos.HayDoctosObligatoriosSinCargarPorVisita() Then Exit Sub

        Dim lstExpedientes As List(Of ucDocumentosVisita) = tcContPestaDocs.GetAllControlsOfType(Of ucDocumentosVisita)()
        Dim lsListaFolios As String = "<ul>"

        For Each ucDocumentosV As ucDocumentosVisita In lstExpedientes
            If ppObjVisita.SubVisitasSeleccionadas.Contains(ucDocumentosV.pObjPropiedades.ppObjVisita.IdVisitaGenerado.ToString()) Or ppObjVisita.IdVisitaGenerado = ucDocumentosV.pObjPropiedades.ppObjVisita.IdVisitaGenerado Then
                If ucDocumentosV.HayDoctosObligatoriosSinCargarPorVisitaSinMensage() Then
                    lsListaFolios &= "<li>" & ucDocumentosV.pObjPropiedades.ppObjVisita.FolioVisita & "</li>"
                End If
            End If
        Next
    ...
    Protected Sub btnFechaReunionVj_Click(sender As Object, e As EventArgs)
        ...
        If Convert.ToDateTime(lsFecha) > fechaConvoca.Date Then
            lblFechaGeneral.Text = "La fecha no puede ser mayor a 4 días hábiles a partir de hoy."
            lblFechaGeneral.Visible = True
            imgErrorGeneral.ImageUrl = Constantes.Imagenes.Fallo
            lblDscFechaPaso.Visible = True
            lblDscFechaPaso.Text = "Elegir fecha tentativa de la reunión opcional de revisión de acta circunstanciada con el área jurídica. "
        ...
        If AccesoBD.ActualizaFechaInicioVisita(objVisita.IdVisitaGenerado, ldFecha, Constantes.TipoFecha.FechaReunionVjp9, objVisita.SubVisitasSeleccionadas, , ldFechaFP8) Then
            ...
            If objVisita.IdEstatusActual = Constantes.EstatusPaso.Elaborada Then
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, objVisita.IdEstatusActual,
                                                                        ...
                                                                        True, True, False, , , , , , , True,,, Constantes.MovimientoPaso.EnviaActaCircunstanciadaRevision
                                                                        )
            Else
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AjustesEnviados,
                                                                        False, -1,
            ...
            If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 8, ppObjVisita.IdArea) Then
                AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 8, ppObjVisita.IdArea, 0, ldFecha)
            Else
                AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 8, ldFecha)
            End If
    ...
    Protected Sub btnFechaReunionRetroComAtAC_Click(sender As Object, e As EventArgs)
        ...
        'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
        If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 15, ppObjVisita.IdArea) Then
            AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 15, ppObjVisita.IdArea, 0, ldFecha)
        Else
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 15, ldFecha)
        End If
    ...
    Protected Sub btnFechaReunionRetroComAtACP17_Click(sender As Object, e As EventArgs)
        ...
        If Convert.ToDateTime(lsFecha) > fechaConvoca.Date Then
            ...
            imgErrorGeneral.ImageUrl = Constantes.Imagenes.Fallo
            lblDscFechaPaso.Visible = True
            lblDscFechaPaso.Text = "¿En qué fecha será la reunión 15.1.- Retroalimentación de comentarios a acta de conclusión?"
            dvRdo.Visible = True
            lblInfoValFechaIngresada.Visible = True
            lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 3 días hábiles a partir de hoy."
    ...
    Protected Sub btnFechaReunionVjP16_Click(sender As Object, e As EventArgs)
        ...
        If Convert.ToDateTime(lsFecha) > fechaConvoca.Date Then
            ...
            imgErrorGeneral.ImageUrl = Constantes.Imagenes.Fallo
            lblDscFechaPaso.Visible = True
            lblDscFechaPaso.Text = "¿En qué fecha será la reunión 14.1.- Revisión de acta de conclusión con la Vicepresidencia Jurídica?"
            dvRdo.Visible = True
            lblInfoValFechaIngresada.Visible = True
            lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 4 días hábiles a partir de hoy."
        ...
        ''Actualiza fecha para la reunion
        If AccesoBD.ActualizaFechaInicioVisita(objVisita.IdVisitaGenerado, ldFecha, Constantes.TipoFecha.FechaReunionVjp16, objVisita.SubVisitasSeleccionadas, "", DateTime.Now) Then

            'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
            If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 14, ppObjVisita.IdArea) Then
                AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 14, ppObjVisita.IdArea, 0, ldFecha)
            Else
                AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 14, ldFecha)
            End If
            ...
            If objVisita.IdEstatusActual = Constantes.EstatusPaso.Revisado Then
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, objVisita.IdEstatusActual,
                                                                     True, Constantes.EstatusPaso.Elaborada,'' + 1
                                                                     True, (objVisita.IdPasoActual + 1), Constantes.EstatusPaso.EnRevisionEspera,
                                                                     True, Constantes.CORREO_ID_NOTIFICA_VJ_ADJUNTA_ACTA_CONCLUSION_OF_RECOMENDACIONES, True, True, , , , , , , , True,,, Constantes.MovimientoPaso.EnviaActaConclusionRevision)
            Else
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, Constantes.EstatusPaso.AjustesEnviados,
                                                                        False, -1,
                                                                        False, -1, -1,
                                                                        ...
                                                                        True, True, False,
                                                                        True, Constantes.TipoReactivacion.FinalizaReactivacion,
                                                                        (objVisita.IdPasoActual + 1), objVisita.IdPasoActual,'' + 1
                                                                        Constantes.EstatusPaso.EnRevisionEspera, , True)
            End If
...
#End Region
    ...
    Protected Sub btnConfFechaReunionVjp9_Click(sender As Object, e As EventArgs)
        ...
        If AccesoBD.ActualizaFechaInicioVisita(objVisita.IdVisitaGenerado, Convert.ToDateTime(lsFecha), Constantes.TipoFecha.FechaReunionVjp9Confirmacion, ppObjVisita.SubVisitasSeleccionadas) Then
            ...
            If ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.Revisado Then
                ...
                '                                                  True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CIRCUNSTANCIADA,,,,,,,,,,,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada)
        ...
        Else
            'Mensaje = "Ocurrió un error al actualizar la fecha para la reunión."
            'ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "MensajeError", "MostrarMensajeError();", True)
        End If
    End Sub
    ...
    Protected Sub btnConfFechaReunionVjP8_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            If ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.Revisado Then
                ...
                'objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                '                                                  True, Constantes.EstatusPaso.Aprobado,
                '                                                  True, 9, Constantes.EstatusPaso.EnRevisionEspera,''REVISAR DETALLE DEL PASO 8
                '                                                  True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CIRCUNSTANCIADA,,,,,,,,,,,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada)

                'SE PIDE LA FECHA EN QUE SE LLEVARÁ A CABO LA REUNIÓN DE RETROALIMENTACIÓN DE ACTA CIRCUNSTANCIADA
                txtFechaGeneral.Text = ""
                lblDscFechaPaso.Visible = True
                lblDscFechaPaso.Text = "¿En qué fecha será la reunión opcional 9.1.- Retroalimentación de comentarios a  acta circunstanciada?"
                dvRdo.Visible = True
                lblInfoValFechaIngresada.Visible = True
                lblInfoValFechaIngresada.Text = "La fecha no puede ser mayor a 3 días hábiles a partir de hoy."
    ...
    Protected Sub btnConfFechaReunionVjp16_Click(sender As Object, e As EventArgs)
        ...
        If Convert.ToDateTime(lsFecha) > DateTime.Now.Date Then
            ...
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitarFechaGeneral('" & Constantes.MensajesModal.FechaRetroalimentacionP13Pasado & "', 'btnFechaRetroalimentacionP13');", True)
            Exit Sub
        End If

        ''Regresa DateTime.MinValue si alguna validacion falla
        'Si se pide una fecha en pasado se deben desactivar las banderas de validar 3 días posteriores

        lblFechaGeneral.Text = ""
        'Se agregaban más parametros posiblemenmte por el funcionamiento anterior en el que se pasaba a paso 17, se deben omitir para el nuevo flujo
        'ldFecha = ValidarFechaGeneral(lsFecha, lblFechaGeneral, imgErrorGeneral, "ConfirmarFechaReunPreciJuridicoP16();", False, False, False, True, PasoProcesoVisita.Pasos.Diesisiete)
        ldFecha = ValidarFechaGeneral(lsFecha, lblFechaGeneral, imgErrorGeneral, "ConfirmarFechaReunPreciJuridicoP16();", True, False, False)
        If ldFecha = DateTime.MinValue Then
            Exit Sub
        End If
        ...
        ''Actualiza fecha para la reunioncase
    ...
    Protected Sub btnFechaInSituActaC_Click(sender As Object, e As EventArgs)
        ...
        If AccesoBD.ActualizaFechaInicioVisita(objVisita.IdVisitaGenerado, ldFecha, Constantes.TipoFecha.FechaInSituActaCircunstanciada, ppObjVisita.SubVisitasSeleccionadas) Then
            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, objVisita.IdEstatusActual,
                                                                         ...
                                                                         False, True, True, , , , , , ldFecha,,,, Constantes.MovimientoPaso.LevantamientoINSITUActaCircunstanciada
                                                                         )
            ...
            If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 11, ppObjVisita.IdArea) Then
                AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 11, ppObjVisita.IdArea, 0, ldFecha)
            Else
                AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 11, ldFecha)
            End If
    ...
    Protected Sub btnFechaRetroalimentacion_Click(sender As Object, e As EventArgs)
        ...
        objNegVisita = New NegocioVisita(objVisita, objUsuario, Server, txbComentarios.Text)
        'Cambia registro a paso 9
        If objVisita.IdPasoActual = 8 Then
            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                                                                 True, Constantes.EstatusPaso.Aprobado,
                                                                 True, 9, Constantes.EstatusPaso.EnRevisionEspera,''REVISAR DETALLE DEL PASO 8
                                                                 True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CIRCUNSTANCIADA,,,,,,,,,,,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada)
    ...
    Protected Sub btnConfirmaFechaRetroalimentacionNo_Click(sender As Object, e As EventArgs)
        ...
        If Convert.ToDateTime(lsFecha) > DateTime.Now.Date Then
            ...
            imgErrorGeneral.ImageUrl = Constantes.Imagenes.Fallo
            txtFechaGeneral.Text = ""
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitarFechaGeneral('" & Server.HtmlDecode(Constantes.MensajesModal.FechaRetroalimentacionPasado) & "', 'btnConfirmaFechaRetroalimentacionNo');", True)
            Exit Sub
        End If

        ''Regresa DateTime.MinValue si alguna validacion falla
        ldFecha = ValidarFechaGeneral(lsFecha, lblFechaGeneral, imgErrorGeneral, "SolicitarFechaGeneral('" & Server.HtmlDecode(Constantes.MensajesModal.FechaRetroalimentacionPasado) & "', 'btnConfirmaFechaRetroalimentacionNo');", False, False, False)
        If ldFecha = DateTime.MinValue Then
            Exit Sub
        End If
        ...
        Else
            ...
            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, objVisita.IdEstatusActual,
                                         ...
                                         True, Constantes.CORREO_VER_FINAL_ACTA_CIRCUNSTANCIADA,
                                         True, True, False, , , , , , , True,,, Constantes.MovimientoPaso.ApruebaComentariosActaCircunstanciada)
        End If
    ...
    Protected Sub btnFechaLevantaActa_Click(sender As Object, e As EventArgs)
        ...
        If AccesoBD.ActualizaFechaInicioVisita(objVisita.IdVisitaGenerado, ldFecha, Constantes.TipoFecha.FechaLevantamientoActaConclusion, ppObjVisita.SubVisitasSeleccionadas) Then
            ...
            If objVisita.TieneSancion Then
                ...
                AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 16, Constantes.Parametros.fechaMinima, 5)

                'SE ENVÍA NOTIFICACIÓN
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, objVisita.IdEstatusActual,
                                     True, Constantes.EstatusPaso.Notificado, ''+1
                                     True, (objVisita.IdPasoActual + 1), Constantes.EstatusPaso.EnRevisionEspera,
                                     True, Constantes.CORREO_ID_NOTIFICA_VJ_PR_HA_LEVANTADO_ACTA_CON_IN_SITU, True, True, False, , , , , , ldFecha, True,,, Constantes.MovimientoPaso.LevantamientoINSITUActaConclusión)
    ...
    Protected Sub btnConfFechaRetroNo_Click(sender As Object, e As EventArgs)
        ...
        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitarFechaGeneral('" & Constantes.MensajesModal.FechaRetroalimentacionPasado & "', 'btnConfirmaFechaRetroalimentacionNo');", True)
        Exit Sub
    ...
    Protected Sub btnConfFechaRetroOk_Click(sender As Object, e As EventArgs)
        ...
        objNegVisita = New NegocioVisita(objVisita, objUsuario, Server, txbComentarios.Text)
        Dim Fecha = AccesoBD.getFechaEstimadaPorPaso(ppObjVisita.IdVisitaGenerado, 9)
        'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
        If AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 9, ppObjVisita.IdArea) Then ''Se Cambia del Numero Id 10  al 9
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 9, Fecha)
        End If
        ...
        Else
            'AVANZA AL PASO 13 pero AHORA AVANZARA AL PASO 10 YA QUE SE ELIMINO LA FECHA
            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, objVisita.IdEstatusActual,
                                      True, Constantes.EstatusPaso.Enviado,
                                      True, 10, Constantes.EstatusPaso.EnRevisionEspera,
                                      True, Constantes.CORREO_VER_FINAL_ACTA_CIRCUNSTANCIADA,
    ...
    Protected Sub btnConfFechaReunionP9ok_Click(sender As Object, e As EventArgs)
        If Not Fechas.Vacia(ppObjVisita.Fecha_ReunionVjPaso9) Then
            ...
            If ldVecFecha.Length = 3 Then
                Dim ldFecha As DateTime = New Date(Convert.ToInt32(ldVecFecha(2)), Convert.ToInt32(ldVecFecha(1)), Convert.ToInt32(ldVecFecha(0)))
    ...
    Protected Sub btnConfFechaReunionP8ok_Click(sender As Object, e As EventArgs)
        ...
        If ppObjVisita.TieneSancion Then
            Me.Mensaje = "La fecha de la reunión 8.1 - Revisión de Acta Circunstanciada fue: " & ppObjVisita.Fecha_ReunionVjPaso9.ToString("dd/MM/yyyy") & "." +
             "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
             "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
             "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
            lblFechaActaCirc.Visible = False
        ...
        Else
            ...
            If ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.Revisado Or ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.AjustesRealizados Then
                ...
                '                                                  True, Constantes.EstatusPaso.Aprobado,
                '                                                  True, 9, Constantes.EstatusPaso.EnRevisionEspera,
                '                                                  True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CIRCUNSTANCIADA,,,,,,,,,,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada) '',,,,,,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada
    ...
    Protected Sub btnConfFechaReunionP9NoDos_Click(sender As Object, e As EventArgs)
        ...
        If AccesoBD.ActualizaFechaInicioVisita(ppObjVisita.IdVisitaGenerado, Date.Now, Constantes.TipoFecha.FechaReunionVjp9NoSeRealizo, ppObjVisita.SubVisitasSeleccionadas) Then
            ...
            'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
            If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 8, ppObjVisita.IdArea) Then
                AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 8, ppObjVisita.IdArea, 0, Constantes.Parametros.fechaMinima)
            Else
    ...
    Protected Sub btnConfFechaReunionP8NoDos_Click(sender As Object, e As EventArgs)
        ...
        If ppObjVisita.TieneSancion Then
            Me.Mensaje = "La fecha de la reunión 7.1 - Revisión de presentación de hallazgos será: " & ppObjVisita.Fecha_ReunionVjPaso9.ToString("dd/MM/yyyy") & "." +
             "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
             "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
             "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
            txtFechaGeneral.Text = Fechas.Valor(ppObjVisita.Fecha_ReunionVjPaso9)
        ...
        Else
            ...
            If ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.Revisado Then
                objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                                                                  True, Constantes.EstatusPaso.Aprobado,
                                                                  True, 12, Constantes.EstatusPaso.EnRevisionEspera,''SE CAMBIA EL PASO DEL 10 AL 12 
                                                                  True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CIRCUNSTANCIADA,,,,,,,,,,,,, Constantes.MovimientoPaso.ApruebaActaCircunstanciada)
            ...
            If ldVecFecha.Length = 3 Then
                ...
                If AccesoBD.ActualizaFechaInicioVisita(ppObjVisita.IdVisitaGenerado, ldFecha, Constantes.TipoFecha.FechaReunionVjp16Confirmacion, ppObjVisita.SubVisitasSeleccionadas) Then
                    ...
                    If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 14, ppObjVisita.IdArea) Then
                        AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 14, ppObjVisita.IdArea, 0, ldFecha)
                    Else
                        AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 14, ldFecha, 3)
                    End If
    ...
    Protected Sub btnConfRetroActaConP18_Click(sender As Object, e As EventArgs)
        ...
        'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
        If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 15, ppObjVisita.IdArea) Then
            AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 15, ppObjVisita.IdArea, 0, Constantes.Parametros.fechaMinima)
        Else
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 15, Constantes.Parametros.fechaMinima, 4)
        End If
        ...
        objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                                                                    ...
                                                                    True, Constantes.CORREO_ID_NOTIFICA_VERSION_FINAL_ACTA_CONCLUSION_OFICIO_RECOMENDACIONES,,,,,,,,,,,,, Constantes.MovimientoPaso.ApruebaComentariosActaConclusion)
    ...
    Protected Sub btnFechaPaso18Conf_Click(sender As Object, e As EventArgs)
        ...
        If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 15, ppObjVisita.IdArea) Then
            AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 15, ppObjVisita.IdArea, 0, Constantes.Parametros.fechaMinima)
        Else
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 15, Constantes.Parametros.fechaMinima, 2)
        End If
    ...
    Protected Sub btnConfFechaReunionVjp16NoDos_Click(sender As Object, e As EventArgs)
        ...
        If AccesoBD.ActualizaFechaInicioVisita(ppObjVisita.IdVisitaGenerado, Date.Now, Constantes.TipoFecha.FechaReunionVjp16NoSeRealizo, ppObjVisita.SubVisitasSeleccionadas) Then
            ...
            'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
            If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 14, ppObjVisita.IdArea) Then
                AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 14, ppObjVisita.IdArea, 0, Constantes.Parametros.fechaMinima)
            Else
                AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 14, Constantes.Parametros.fechaMinima, 2)
            End If
                        ...
                        Select Case objUsuario.IdentificadorPerfilActual
                            Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP
                                If EsAreaOperativa(objUsuario.IdArea) Then
                                    ...
                                    If objUsuario.IdArea = Constantes.AREA_VF And visita.TieneSubVisitas Then
                                        imgSiguiente.Attributes.Add("onClick", " return MuestraSubvisitas('imgSiguiente'); ")
                                        lbTienePermiso = True
                                    Else
                                        lbTienePermiso = True
                    ...
                    Case Constantes.EstatusPaso.EnRevisionEspera
                        Select Case objUsuario.IdentificadorPerfilActual
                            Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS, Constantes.ABOGADOS.PERFIL_ABO_ASESOR
                                ...
                                'End If
                        End Select
                    Case Constantes.EstatusPaso.Visita_iniciada, Constantes.EstatusPaso.Visita_Finalizada ''Paso 6 detener visita
                        Select Case objUsuario.IdentificadorPerfilActual
                            Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS, Constantes.ABOGADOS.PERFIL_ABO_ASESOR
                                'Ocultar tabla
                                divComentarios.Visible = False
                        ...
                        End Select
                End Select
                'Comente el codigo del paso 7 PARA habilitar
                'Case 7
                '    Select Case objVisita.IdEstatusActual
                '        Case Constantes.EstatusPaso.En_diagnostico_de_hallazgos ''paso 7 En_diagnostico_de_hallazgos
                '            'Ocultar tabla
            ...
            Case 10
                ...
                Select Case objVisita.IdEstatusActual
                    ...
                    Case Constantes.EstatusPaso.Notificado ''Paso automatico, cuando alguin ca la visita y ya esta en la fecha de reunion afore, pasa la visita al paso 13
                        ...
                        If objVisita.IdPasoActual = 10 And
                      (objUsuario.IdentificadorPerfilActual = Constantes.PERFIL_SUP Or objUsuario.IdentificadorPerfilActual = Constantes.PERFIL_ADM) And
                      (objUsuario.IdArea <> Constantes.AREA_VJ) And
            ...
            Case 14
                Select Case objVisita.IdEstatusActual
                    ...
                    Case Constantes.EstatusPaso.Revisado, Constantes.EstatusPaso.AjustesRealizados ''Flujo inicial paso 17, Revisado, ''Flujo inicial paso 17, Revisado, regresa paso 16
                        ...
                        End Select
                End Select
                'Comentar con adriana
            'Case 17
            '    Dim irregularidadesRegistradas As DataTable = Entities.IrregularidadVisita.ObtenerTodas(objVisita.IdVisitaGenerado)
            '    If irregularidadesRegistradas.Rows.Count > 0 Then
            '        'Validar que se tengan irregularidades guardadas
            '        imgGuardarCambios.Visible = True
            '        imgGuardarCambios.Enabled = True
            '        lbTienePermiso = True

            '    End If
                'Se mofica caso de 18 al 15
            Case 15
                Select Case objVisita.IdEstatusActual
                    Case Constantes.EstatusPaso.EnRevisionEspera ''Flujo inicial paso 18, EnRevisionEspera
                        Select Case objUsuario.IdentificadorPerfilActual
            ...
            Case 16
                Select Case objVisita.IdEstatusActual
                    ...
                    Case Constantes.EstatusPaso.Revisado
                        ...
                        End Select
                End Select
'Se mofica caso de 20 al 17
            Case 17 ' se agrega sección de paso 20 con permisos para VO/VF/CGIV AMMM - 01/10/2018
                Select Case objVisita.IdEstatusActual
                    Case Constantes.EstatusPaso.EnRevisionEspera
                        Select Case objUsuario.IdentificadorPerfilActual
                    ...
                    Case Constantes.EstatusPaso.Revisado
                        Select Case objUsuario.IdentificadorPerfilActual
                            Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS ''Paso 20 manda a paso 21
                                If EsAreaOperativa(objUsuario.IdArea) Then
                                    'imgNotificar3.Visible = True
                                    'imgNotificar3.Enabled = True
                    ...
                    Case Constantes.EstatusPaso.EnRevisionEspera ''Paso 21 guarda comentarios, EnRevisionEspera
                        Select Case objUsuario.IdentificadorPerfilActual
                            Case Constantes.PERFIL_ADM, Constantes.PERFIL_SUP, Constantes.PERFIL_INS
                                If EsAreaOperativa(objUsuario.IdArea) Then
                                    imgGuardarCambios.Visible = True
                                    imgGuardarCambios.Enabled = False 'se cambia a false para que ya no avancen de paso 22
                                    lbTienePermiso = True
                                End If
                        End Select
                    Case Constantes.EstatusPaso.Revisado ''Paso 21 guarda comentarios, Revisado
    ...
    Protected Sub btnPasoCincoConfirmSi_Click(sender As Object, e As EventArgs) Handles btnPasoCincoConfirmSi.Click
        ...
        '  Se pasa a función  Protected Sub btnFechaCampo_Click(sender As Object, e As EventArgs)
        'If Not IsNothing(visita) And visita.IdVisitaGenerado > 0 And Not IsNothing(Usuario) Then
        '   ''Objeto negocio visita
        '   Dim objNegVisita As New NegocioVisita(visita, Usuario, Server, txbComentarios.Text)
    ...
    Protected Sub btnPasoCincoConfirmNo_Click(sender As Object, e As EventArgs) Handles btnPasoCincoConfirmNo.Click
        ...
        ''inserta un nuevo documento en blanco para el paso 5
        ...
        'campos.Add("T_DSC_COMENTARIO")
        'campos.Add("N_ID_TIPO_DOCUMENTO")
        'campos.Add("F_FECH_REGISTRO")
        'campos.Add("F_FECH_ACTUALIZACION")
        'campos.Add("T_ID_USUARIO")
        'campos.Add("I_ID_PASO_REG_UPD_DOC")


        'valores.Add(visita.IdVisitaGenerado)
        'valores.Add("5")
        'valores.Add("9")
        'valores.Add(" ")
        'valores.Add(" ")
        ...
        'valores.Add(Date.Now)
        'valores.Add(Usuario.IdentificadorUsuario)
        'valores.Add("5")
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Protected Sub btnPasoSieteConfirmSi_Click(sender As Object, e As EventArgs) Handles btnPasoSieteConfirmSi.Click
        ''Objeto negocio visita
    ...
    Protected Sub btnPasoSieteConfirmNo_Click(sender As Object, e As EventArgs) Handles btnPasoSieteConfirmNo.Click
        hdfPresentacionP6y7.Value = "Continuar"
        Me.Mensaje = "¿Habrá sanción para la visita?"
        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "PreguntarSancionPasoSiete();", True)
        Exit Sub
    ...
    Protected Sub btnPasoSieteConfirmNo_V17_Click(sender As Object, e As EventArgs)
        ...
        '    objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
        '                                                         True, Constantes.EstatusPaso.Hallazgos_presentados_notificado,
        '                                                         True, 7, Constantes.EstatusPaso.EnRevisionEspera,''se movio el paso siguiente de 7 a 8
        '                                                         False, -1)
        '    Response.Redirect("../Procesos/DetalleVisita_V17.aspx")
        'End If
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    ''' AQUI TAMBIEN SE MODIFICO LOS PASOS GP
    Protected Sub btnConfSanPasoSieteSi_Click(sender As Object, e As EventArgs) Handles btnConfSanPasoSieteSi.Click


        If Not IsNothing(ppObjVisita) And Not IsNothing(puObjUsuario) Then
            Dim objNegVisita As New NegocioVisita(ppObjVisita, puObjUsuario, Server, txbComentarios.Text)
            hfFlujoActualPaso.Value = "7"
            'reaiza cambio de paso a 7
            'objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
            '                                                     True, Constantes.EstatusPaso.Hallazgos_presentados_notificado,
            '                                                     True, 7, Constantes.EstatusPaso.EnRevisionEspera,''se movio el paso siguiente de 7 a 8
            '                                                     False, -1)
            ...
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitaFechaRevHallazgos();", True)
            'Response.Redirect("../Procesos/DetalleVisita_V17.aspx") ''COMENTO EL CODIGO PARA HACER PRUEBAS
        End If
    End Sub
    '' AQUI TAMBIEN SE MODIFICO LOS PASOS GP 

    ''CORREGIR EL PASO 7.1 AQUI IMPLEMENTACION DE MENSAJE 7.1
    Protected Sub btnConfSanPasoSieteSi_V17_Click(sender As Object, e As EventArgs)
        If Not IsNothing(ppObjVisita) And Not IsNothing(puObjUsuario) Then
            ...
            End If
            ''MODIFICO GP Y EL CAMBIO FUE PASO 8 A 7
            objNegVisita.PasoGenerericEstatusPasoNotificarReactivar(True, ppObjVisita.IdEstatusActual,
                                                                 True, Constantes.EstatusPaso.Hallazgos_presentados_notificado,
    ...
    Protected Sub btnCancelaFechaReunionVjp9_Click(sender As Object, e As EventArgs)
        ...
        If Not IsNothing(ppObjVisita) Then
            ...
            Mensaje = "La fecha de la reunión 8.1 - Revisión de Acta circunstanciada con el área de Supervisión fue: " & fechaP9 & "." +
                     "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                     "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                     "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
    ...
    Protected Sub btnCancelaFechaReunionVjp16_Click(sender As Object, e As EventArgs)
        If Not IsNothing(ppObjVisita) Then
            'Mensaje = "La fecha de la reunión 14.1 - Revisar Acta de conclusión fue: " & ppObjVisita.Fecha_ReunionVjPaso16.ToString("dd/MM/yyyy") & "."
            Mensaje = "La fecha de la reunión 14.1 - Revisar Acta de conclusión con el área de Supervisión fue: " & ppObjVisita.Fecha_ReunionVjPaso16.ToString("dd/MM/yyyy") & "." +
                                               "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
                                               "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
                                               "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
            txtFechaGeneral.Text = Fechas.Valor(ppObjVisita.Fecha_ReunionVjPaso16)
    ...
    <System.Web.Services.WebMethod()>
    Public Shared Function ActualizarEstatusEnviadoSISAN(IdVisita As Integer, IdArea As Integer, Usuario As String) As Boolean
        Dim _save As Boolean = False
        Dim listCampos As New List(Of String)
        Dim lstCampoCond As New List(Of String)
        Dim lstCampoCondicionSubvisitas As New List(Of String)
        ...
        'listCampos.Add("I_ID_PASO_ACTUAL") : listValores.Add(10)
        listCampos.Add("I_ID_ESTATUS_ACTUAL") : listValores.Add(12)

        lstCampoCond.Add("I_ID_VISITA") : lstValCondicion.Add(IdVisita)
        lstCampoCondicionSubvisitas.Add("I_ID_VISITA_PADRE_SB")
        ...
        Try
            ...
            _estatus = listCampos.IndexOf("I_ID_ESTATUS_ACTUAL")
            _estatus = listValores(_estatus).ToString()

            bitacora = New Conexion.Bitacora("Envio a SISAN ", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)

            _save = conexion.ActualizarConTransaccion("BDS_D_VS_VISITA", listCampos, listValores, lstCampoCond, lstValCondicion, tran)
            conexion.ActualizarConTransaccion("BDS_D_VS_VISITA", listCampos, listValores, lstCampoCondicionSubvisitas, lstValCondicion, tran)

            conexion.InsertarConTransaccion("BDS_D_VS_ESTATUS_PASO", IdVisita & ",17,12,GETDATE(),'" & Usuario & "','','USUARIO',12," & IdArea & "," & Constantes.MovimientoPaso.REgistraIrregularidadSISAN, tran)


            bitacora.Insertar("BDS_V_VISITA_BITACORA", listCampos, listValores, _save, "")
        Catch ex As Exception
            _save = False
            tran.Rollback()
            bitacora.Insertar("BDS_V_VISITA_BITACORA", listCampos, listValores, _save, ex.Message)
            Utilerias.ControlErrores.EscribirEvento(ex.ToString, EventLogEntryType.Error)
            Throw ex
        Finally
    ...
    Public Shared Function wsCargandoIrreg(IDIrreg As Integer) As String  '
        ...
        query = "Select * FROM [dbo].[BDS_R_VI_IRREGULARIDAD] WHERE I_ID_IRREGULARIDAD = " + IDIrreg.ToString()
        ...
        With dt.Rows(0)
            ...
            strCadena = strCadena & .Item("N_ID_FOLIO").ToString & "|"
        End With

        Return strCadena
    End Function
    'Elimina irregularidadC
    <System.Web.Services.WebMethod()>
    Public Shared Function wsEliminandoIrreg(IDIrreg As Integer) As Boolean  '
        Dim conexion As New Conexion.SQLServer()
        Return conexion.Ejecutar("DELETE FROM [dbo].[BDS_R_VI_IRREGULARIDAD] WHERE I_ID_IRREGULARIDAD = " + IDIrreg.ToString())
    End Function
    <System.Web.Services.WebMethod()>
    Public Shared Function ValidacionSISAN(Folio As Integer, FolioVisita As String, FechaInicioActoSup As String, FechaFinActoSup As String, Usuario As String, IdEntidad As Integer, IdTipoEntidad As Integer) As String
        ...
        Dim tipoEntidad As Integer = IdTipoEntidad

        Dim entidad As Integer = IdEntidad
        Dim clasificacion As Integer = 3 'VISTA
        ...
        Dim oficioSICODSubvisita As String = ""

        Dim folioSISAN As String = ""
        Dim folioSubvisitaSISAN As String = ""

        Dim ListaCampos As New List(Of String)
        Dim ListaCamposSubvisitas As New List(Of String)
        Dim ListaValores As New List(Of Object)
        Dim ListaValoresSubvisitas As New List(Of Object)
        Dim ListaCamposCondicion As New List(Of String)
        Dim ListaCamposCondicionSubvisitas As New List(Of String)
        Dim ListaValoresCondicion As New List(Of Object)
        Dim ListaValoresCondicionSubvisitas As New List(Of Object)
        Dim mensajes As String() = {}
        Dim resultado As Boolean = True
        Dim MensajeResult As String = ""
        Dim conexionC As New Conexion.SQLServer()

        'Validar si se tienen subvisitas
        conexionC = New Conexion.SQLServer()
        Dim querySubvisitas As String = "SELECT * FROM BDS_D_VS_VISITA WHERE I_ID_VISITA_PADRE_SB = " & Folio
        Dim dtSubvisitas As DataTable = conexionC.ConsultarDT(querySubvisitas)
        conexionC.CerrarConexion()
        If dtSubvisitas.Rows.Count > 0 Then
            For Each drSubvisita As DataRow In dtSubvisitas.Rows
                conexionC = New Conexion.SQLServer()
                Dim queryDocumentoDictamenSubvisita As String = "SELECT * FROM BDS_D_VS_DOCUMENTO_PASO WHERE I_ID_VISITA=" & drSubvisita("I_ID_VISITA") & " AND N_ID_DOCUMENTO=" & 37
                Dim dtDocumentoDictamenSubvisita As DataTable = conexionC.ConsultarDT(queryDocumentoDictamenSubvisita)
                conexionC.CerrarConexion()
                If dtDocumentoDictamenSubvisita.Rows.Count > 0 Then
                    'Verificar si se tiene un folio SICOD
                    If IsDBNull(dtDocumentoDictamenSubvisita.Rows(0)("T_FOLIO_SICOD")) Then
                        MensajeResult = MensajeResult & "Error: La subvisita " & drSubvisita("T_ID_FOLIO") & " no tiene un documento de dictamen con folio SICOD. "
                    Else
                        'Verificar si cada subvisita tiene un documento de dictamen concluido
                        If ConexionSICOD.FolioFinalizado(dtDocumentoDictamenSubvisita.Rows(0)("T_FOLIO_SICOD")) Then

                        Else
                            MensajeResult = MensajeResult & "Error: La subvisita " & drSubvisita("T_ID_FOLIO") & " no tiene un documento de dictamen con estatus concluido. "
                        End If
                    End If
                Else
                    MensajeResult = MensajeResult & "Error: La subvisita " & drSubvisita("T_ID_FOLIO") & " no ha registrado un documento de dictamen. "
                End If
            Next
        End If

        If MensajeResult.Length = 0 Then
            Dim query As String = "SELECT * FROM BDS_D_VS_DOCUMENTO_PASO WHERE I_ID_VISITA=" & Folio & " AND N_ID_DOCUMENTO=" & 37
            Dim dtDictamen As DataTable = conexionC.ConsultarDT(query)
            conexionC.CerrarConexion()
            If dtDictamen.Rows.Count > 0 Then
            ...
            Dim resultadoRegistro As wsSisanRegV2.WsResultado = Registro.RegistroExterno("FOL. REF", Usuario, sistema, tipoEntidad, entidad, subentidad, 1, clasificacion, FolioVisita, FechaInicioActoSup, FechaFinActoSup, oficioSICOD, "prueba", Usuario, "ninguno")
            ...
            If Not resultadoRegistro.isError Then
                ...
                Dim irregularidades As DataTable = Entities.IrregularidadVisita.ObtenerTodas(Folio)
                If irregularidades.Rows.Count > 0 Then
                    For Each irregularidad As DataRow In irregularidades.Rows
                        Dim resultadoIrregularidad As wsSisanRegV2.WsResultado = Registro.RegistroIncidencias(irregularidad("I_ID_IRREGULARIDAD"), resultadoRegistro.Irregularidad, irregularidad("F_FECH_IRREGULARIDAD"), irregularidad("T_DSC_COMENTARIO"))
                ...
                For Each drSubvisita As DataRow In dtSubvisitas.Rows
                    ...
                    If dtDocumentoDictamenSubvisita.Rows.Count > 0 Then
                        oficioSICODSubvisita = dtDocumentoDictamenSubvisita.Rows(0)("T_FOLIO_SICOD")
                    End If

                    Dim resultadoRegistroSubVisita As wsSisanRegV2.WsResultado = Registro.RegistroExterno("FOL. REF", Usuario, sistema, drSubvisita("I_ID_TIPO_ENTIDAD"), drSubvisita("I_ID_ENTIDAD"), drSubvisita("I_ID_SUBENTIDAD"), 1, clasificacion, drSubvisita("I_ID_VISITA"), FechaInicioActoSup, FechaFinActoSup, oficioSICODSubvisita, "", Usuario, "")
                    If Not resultadoRegistroSubVisita.isError Then
                        folioSubvisitaSISAN = resultadoRegistroSubVisita.Folio

                        For Each irregularidad As DataRow In irregularidades.Rows
                            Dim resultadoIrregularidad As wsSisanRegV2.WsResultado = Registro.RegistroIncidencias(irregularidad("I_ID_IRREGULARIDAD"), resultadoRegistroSubVisita.Irregularidad, irregularidad("F_FECH_IRREGULARIDAD"), irregularidad("T_DSC_COMENTARIO"))
                            If resultadoIrregularidad.isError Then
                                mensajes = resultadoIrregularidad.lstMensajes
                                resultado = False
                                Exit For
                        ...
                        'Guardado REGISTRO sisan 
                        'Reiniciar variables para consulta
                        ListaCamposSubvisitas = New List(Of String)
                        ListaValoresSubvisitas = New List(Of Object)
                        ListaCamposCondicionSubvisitas = New List(Of String)
                        ListaValoresCondicionSubvisitas = New List(Of Object)

                        ListaCamposSubvisitas.Add("T_ID_FOLIO_SISAN") : ListaValoresSubvisitas.Add(folioSubvisitaSISAN)
                        ListaCamposCondicionSubvisitas.Add("I_ID_VISITA") : ListaValoresCondicionSubvisitas.Add(drSubvisita("I_ID_VISITA"))

                        Dim conexion As New Conexion.SQLServer()
                        conexion.Actualizar("BDS_D_VS_VISITA", ListaCamposSubvisitas, ListaValoresSubvisitas, ListaCamposCondicionSubvisitas, ListaValoresCondicionSubvisitas)
                        conexion.CerrarConexion()

                        'Dim irregularidadesSubvisita As DataTable = IrregularidadVisita.ObtenerTodas(drSubvisita("I_ID_VISITA"))
                        'For Each irregularidadSubVisita In irregularidadesSubvisita.Rows
                        '    Dim resultadoIrregularidadSubvisita As wsSisanRegV2.WsResultado = Registro.RegistroIncidencias(irregularidadSubVisita("I_ID_IRREGULARIDAD"), resultadoRegistroSubVisita.Irregularidad, irregularidadSubVisita("F_FECH_IRREGULARIDAD"), irregularidadSubVisita("T_DSC_COMENTARIO"))
                        '    If resultadoIrregularidadSubvisita.isError Then
                        '        mensajes = resultadoIrregularidadSubvisita.lstMensajes
                        '        resultado = False
                        '    End If
                        'Next
                    Else
                        mensajes = resultadoRegistroSubVisita.lstMensajes
                        resultado = False
                    End If
                Next
            ...
            If resultado Then
                ...
                ListaCamposCondicion.Add("I_ID_VISITA") : ListaValoresCondicion.Add(Folio)

                Dim conexion As New Conexion.SQLServer()
                conexion.Actualizar("BDS_D_VS_VISITA", ListaCampos, ListaValores, ListaCamposCondicion, ListaValoresCondicion)
                conexion.CerrarConexion()
            Else
                MensajeResult = "Error"
    ...
    Private Sub VisibilidadTabDatSisan(isVisible As Boolean)
        If isVisible Then
            If ((puObjUsuario.IdentificadorPerfilActual = Constantes.PERFIL_ADM OrElse
                            ...
                            puObjUsuario.IdentificadorPerfilActual = Constantes.PERFIL_INS) And
                ppObjVisita.IdEstatusActual = 12) Then

                liExpedientes.Visible = True
                tabExpedienteSISAN.Visible = True
                SancionPC1.Visible = True
                SancionPC1.Inicializar(hfFolioSISAN.Value, True)
                PnlButtonES.Visible = True
                ImgBtnESHome.Visible = True
                ImgBtnESHome.Enabled = True
                ImaBtnESExpediente.Visible = True
                ImaBtnESExpediente.Enabled = True
            End If
        Else
    ...
    Protected Sub btnConfFechaP13OK_Click(sender As Object, e As EventArgs)

        Dim ldFecha As String = AccesoBD.getFechaEstimadaPorPaso(ppObjVisita.IdVisitaGenerado, 13)
        ''Actualiza fecha para la reunion
        ...
        If ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.Revisado Or ppObjVisita.IdEstatusActual = Constantes.EstatusPaso.AjustesRealizados Then
            ...
            '                                                            True, Constantes.CORREO_ID_NOTIFICA_APRUEBA_ACTA_CIRCUNSTANCIADA,,,,,,,,,,,,, Constantes.MovimientoPaso.EnviaActaConclusionRevision
            '                                                            )

            'Apica para dos casos, REVISAR
            'Constantes.MovimientoPaso.EnviaActaConclusionRevision
        ...
        '    'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
        '    If AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 13, ppObjVisita.IdArea) Then
        '    AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 13, Constantes.Parametros.fechaMinima, 1)
        'End If

        'lblFechaActaCirc.Text = AccesoBD.getFechaEstimadaPorPaso(ppObjVisita.IdVisitaGenerado, 13)
        'Dim FechaCon As String = lblFechaActaCirc.Text

        'If ppObjVisita.TieneSancion Then
        '    Me.Mensaje = "La reunión 14.1 para revisar la respuesta de la AFORE con VJ se llevó a cabo en la fecha: " & FechaCon.ToString("dd/MM/yyyy") & "." +
        '     "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
        '     "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
        '     "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
        '    lblFechaActaCirc.Visible = False
        ...
        'If Convert.ToDateTime(lsFecha) > fechaConvoca.Date Then
        '    lblPresentaHallazgoss.Text = "La fecha ingresada no puede ser mayor a la fecha actual."
        '    lblPresentaHallazgoss.Visible = True
        '    Image18.ImageUrl = Constantes.Imagenes.Fallo
        '    txtFechRevHallazgoss.Text = ""
        '    ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "SolicitaFechaRevHallazgos_V17_SC();", True)
        ...
        '''Regresa DateTime.MinValue si alguna validacion falla
        'ldFechaCampo = ValidarFechaGeneral(lsFecha, lblPresentaHallazgoss, Image18, "SolicitaFechaRevHallazgos_V17_SC();", False, False, True)
        'If ldFechaCampo = DateTime.MinValue Then
        '    Exit Sub
        'End If
        ...
        'If ppObjVisita.TieneSancion Then
        '    Me.Mensaje = "La reunión 14.1 para revisar la respuesta de la AFORE con VJ se llevó a cabo en la fecha: " & ppObjVisita.Fecha_ReunionVjPaso16.ToString("dd/MM/yyyy") & "." +
        '     "<ul><li>Si: Estas de acuerdo que  la reunión se realizó en la fecha mostrada.</li>" +
        '     "<li>No: Se te solicitará ingresar la fecha real en que se realizó la reunión.</li>" +
        '     "<li>No se llevó a cabo: Confirmas que la reunión no se realizó.</li></ul>"
        '    lblFechaActaCirc.Visible = False
    ...
    Protected Sub btnConfFechaP13NO_Click(sender As Object, e As EventArgs)

        'VALIDA SI VISITA YA CUENTA CON LA FECHA ESTIMADA, SI SÍ, ACTUALIZA LA FECHA ESTIMADA POR LA FECHA REAL, DE LO CONTRARIO LA INSERTA 
        If Not AccesoBD.ExisteVisitaConFechaEstimada(ppObjVisita.IdVisitaGenerado, 13, ppObjVisita.IdArea) Then
            AccesoBD.InsertaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 13, ppObjVisita.IdArea, 0, Constantes.Parametros.fechaMinima)
        Else
            AccesoBD.ActualizaFechaInicioVisita_TblFechasEstimadas(ppObjVisita.IdVisitaGenerado, 13, Constantes.Parametros.fechaMinima, 2)
        End If
    ...
    Protected Sub btnConfFechaP13NoDos_Click(sender As Object, e As EventArgs)
        Dim ldFecha As String = AccesoBD.getFechaEstimadaPorPaso(ppObjVisita.IdVisitaGenerado, 13)
        ''Actualiza fecha para la reunion
    ...
    Protected Sub btnFechaRetroalimentacionP13_Click(sender As Object, e As EventArgs)
        ''Validar que este llena y sea correcta la fecha
        Dim lsFecha As String = txtFechaGeneral.Text.Trim()
        Dim ldFecha As DateTime
        ...
        'VALIDA QUE LA FECHA SELECCIONADA PARA LA CONVOCATORIA NO SEA MAYOR A LA FECHA ACTUAL MÁS 3 DÍAS HÁBILES
        'Dim fechaConvoca As DateTime = AccesoBD.ObtenerFecha(DateTime.Now, 3, Constantes.IncremeteDecrementa.Incrementa)
        'Si la fechaConvoca no debe ser mayor a la fecha actual, fechaConvoca debe tener el valor de la fecha actual
        Dim fechaConvoca As DateTime = DateTime.Now.Date

        If Convert.ToDateTime(lsFecha) > fechaConvoca Then
            lblFechaGeneral.Text = "La fecha ingresada no puede ser mayor a la fecha actual."
            lblFechaGeneral.Visible = True
            imgErrorGeneral.ImageUrl = Constantes.Imagenes.Fallo
            txtFechaGeneral.Text = ""
        ...
        ''Regresa DateTime.MinValue si alguna validacion falla
        lblFechaGeneral.Text = "*Favor de ingresar una fecha valida"

        ldFecha = ValidarFechaGeneral(lsFecha, lblFechaGeneral, imgErrorGeneral, "SolicitarFechaGeneral('" & Constantes.MensajesModal.FechaRetroalimentacionP13Pasado & "', 'btnFechaRetroalimentacionP13');", True, False)
        If ldFecha = DateTime.MinValue Then
            Exit Sub
        End If
    ...
    Public Shared Function ObtenerDatosModificarIrregularidad(Irregularidad As Integer) As List(Of String)
        ...
        query = "Select * FROM [dbo].[BDS_R_VI_IRREGULARIDAD] WHERE I_ID_IRREGULARIDAD = " + Irregularidad.ToString()
        dt = conexion.ConsultarDT(query)

        With dt.Rows(0)
            lDatos.Add(.Item("F_FECH_IRREGULARIDAD").ToString.Substring(0, 10))
            lDatos.Add(.Item("I_ID_PROCESO").ToString)
            lDatos.Add(.Item("I_ID_SUBPROCESO").ToString)
            lDatos.Add(.Item("I_ID_CONDUCTA").ToString)
            lDatos.Add(.Item("I_ID_IRREGULARIDADES").ToString)
            lDatos.Add(.Item("T_DSC_COMENTARIO").ToString)
            lDatos.Add(.Item("I_ID_IRREGULARIDAD").ToString)
            lDatos.Add(.Item("N_ID_FOLIO").ToString)
        End With
    ...
    Public Shared Function ActualizarIrregularidad(Folio As Integer,
        ...
        Entities.IrregularidadVisita.Actualizar(lstCampos, lstValores, lstCaposCondicion, lstValoresCondicion)
