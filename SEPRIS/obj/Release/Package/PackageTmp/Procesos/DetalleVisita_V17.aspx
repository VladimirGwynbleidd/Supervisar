 <%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetalleVisita_V17.aspx.vb" Inherits="SEPRIS.DetalleVisita_V17" MasterPageFile="~/Master/SiteInterno.Master" EnableEventValidation="false" %>
...
<%@ Register Src="~/Controles/ucDocumentosVisita.ascx" TagPrefix="ucd" TagName="ucDocumentosVisita" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="tabs_wrapper" style="margin-top: 20px; height: 47px;">
        ...
        <ul id="Ul2" class="tabs" runat="server" style="width: 100%;">
            ...
            <li id="liExpedientes" runat="server" visible="false"><a href="#tab7">Expediente SISAN</a></li>
        </ul>
...
<cuv:cuDetalleVisita runat="server" ID="cuDetallePrincipal" />
            ...
            <table id="tbHallazgozInt" runat="server" visible="false" width="40%">
                <tr>
                    ...
                    <td>
                        <asp:ImageButton ID="btnEditAllazgosInt" runat="server" ImageUrl="~/Imagenes/icono_lapiz.GIF" OnClientClick="return MuestraSubvisitas('btnEditAllazgosInt');" Width="20px" ToolTip="Editar Fecha" />
                    </td>
                </tr>
            </table>
            ...
            <table id="tbHallazgozExt" runat="server" visible="false" width="40%">
                <tr>
                    ...
                    <td>
                        <asp:ImageButton ID="btnEditAllazgosExt" runat="server" ImageUrl="~/Imagenes/icono_lapiz.GIF" OnClientClick="return MuestraSubvisitas('btnEditAllazgosExt');" Width="20px" ToolTip="Editar Fecha" />
                    </td>
                </tr>
            </table>
            ...
            <table id="tbVulnerabilidad" runat="server" visible="false" width="40%">
                <tr>
                    ...
                    <td>
                        <asp:ImageButton ID="ImgFecVulnerabilidad" runat="server" ImageUrl="~/Imagenes/icono_lapiz.GIF" OnClientClick="return SolicitarFechaVulnerabilidad();" Width="20px" ToolTip="Editar Fecha" />
                    </td>
                </tr>
            </table>
            ...
            <table id="tbBotones">
                ...
                <tr>
                    <td style="width: 100%; text-align: center">
                        ...
                        <asp:ImageButton OnClientClick="MuestraImgCarga(this); " ID="imgGuardarCambios" runat="server" ImageUrl="../Imagenes/registrarVisita.png" ToolTip="Guardar cambios" />
        ...
        <div id="tab3" class="tab_content" style="horizontal-align: left; width: 100%; border: 1px solid #999; font-family: Verdana; font-size: 0.8em; padding: 0px; height: auto;">
            ...
            <ajx:TabContainer ID="tcContPestaDocs" runat="server" Width="90%" Font-Bold="false" ActiveTabIndex="0"
                ...
                <ajx:TabPanel HeaderText="Principal" runat="server" CssClass="tabPestanias" TabIndex="0" ID="tpPestaniasDocsP">
                    <ContentTemplate>
                        <ucd:ucDocumentosVisita runat="server" ID="ucDocumentosVisita" />
        ...
        <asp:Panel ID="tabExpedienteSISAN" runat="server" Visible="false">
            <div id="tab7" class="tab_content" style="horizontal-align: left; width: 100%; border: 1px solid #999; font-family: Verdana; font-size: 0.8em; padding: 0px; height: auto;">
                <uc9:SancionPC runat="server" ID="SancionPC1" Visible="false" />
                    <asp:Panel ID="PnlButtonES" runat="server" Visible="true">
                        <asp:ImageButton ID="ImgBtnESHome" runat="server" src="../Imagenes/inicio.png" Width="40px" OnCommand="btnHome_Command" ToolTip="Ir a bandeja de visitas" />
                        <asp:ImageButton ID="ImaBtnESExpediente" runat="server" OnClientClick="setActiveTab('li3'); return false;" Width="40" src="../Imagenes/IrADetallevisita.png" alt="Detalle" ToolTip="Ver expediente" />
                    </asp:Panel>
            </div>
        </asp:Panel>
        <br />
    ...
    <asp:HiddenField ID="hfFolioSISAN" runat="server" />
    ...
    <div id="dvFechaConvocatoriaAgendar_P11" style="display: none;" title="Confirmación">
        <table width="100%">
            <tr>
                ...
                <td style="text-align: left">
                    <div class="MensajeModal-UI"><%--SE MODIFICA GP AL PASO ACTUAL DE 9.1 A 8.1--%>
                        ¿En qué fecha será la reunión 8.1 para revisión de Acta Circunstanciada con la Vicepresidencia Jurídica?
                    </div>
                    <div class="MensajeModal-UI">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        ...
                        <ul>
                            <li>Si: Se regresará visita a paso 1 para que modifiques documentación inicial.
                            </li>
                            <li>No: Visita se quedará en paso 3 para que continúes con el flujo.
                            </li>
                        </ul>
                    </div>
                </td>
    ...
    <div id="divMensajeUnBotonNoP13" style="display: none" title="Información">
        <table width="100%">
            <tr>
                <td style="width: 50px; text-align: center; vertical-align: top">
                    <asp:Image ID="Image23" runat="server" Width="32px" Height="32px" ImageUrl="~/Imagenes/Errores/1Error.png" />
                </td>
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        <%= Mensaje%>
                        <asp:Label ID="lblFechaa" runat="server" Text="*Texto dinamico." Font-Size="Small" Visible="false"></asp:Label>
    ...
    <div id="divMensajeDosBotonesUnaAccion_SolicitarFechaFinVisita" style="display: none;" title="Visita in situ">
        <table width="100%">
            <tr>
                ...
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        Para  terminar el conteo de los días de la visita in situ, por favor ingresa la fecha fin  en el siguiente espacio: 
                    </div>
                    <br />
                    <div class="MensajeModal-UI">
    ...
    <div id="divMensajeDosBotonesUnaAccion_FinalizaPaso7" style="display: none;" title="Visita in situ">
        <table width="100%">
            <tr>
                ...
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        Se finalizará conteo de días de visita in situ, ¿Deseas continuar?
                        <ul>
                            <li>Aceptar: Se avanzará visita a paso 8.
                            </li>
                            <li>Cancelar: Se regresará a pantalla y se seguirá con el conteo de días.
                            </li>
                        </ul>
                        Nota: El paso 7 -"Diagnóstico de Hallazgos" se lleva a cabo de manera interna. 
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div id="dvFechaRevisionHallazgosVJ" style="display: none;" title="Revisar Presentación de Hallazgos">
        <table width="100%">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        Elegir fecha tentativa de la reunión opcional 7.1, maximo al 4to día para revisar los hallazgos con Vicepresidencia Jurídica
                        <%--7.1 Elegir fecha tentativa de la reunión opcional al 4to día para revisar los hallazgos con Vicepresidencia Jurídica--%>
                    </div>
                    <br />
                    <div class="MensajeModal-UI">
                        ...
                        <b>Recuerda: </b>
                        <asp:Label ID="lblInfoPregunta81" runat="server" Text="La fecha no puede ser mayor a 4 días hábiles a partir de hoy." Font-Size="Small" ForeColor="Black" Visible="true"></asp:Label>
                        <br />
     ...
     <div id="dvFechaRevisionHallazgosVJp13" style="display: none;" title="Revisar Presentación de Hallazgos">
        <table width="100%">

            <tr>
                <td style="width: 50px; text-align: center; vertical-align: top">
                    <asp:Image ID="Image21" runat="server" Width="32px" Height="32px" ImageUrl="~/Imagenes/Errores/1Error.png" />
                </td>
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        Elegir fecha tentativa de la reunión opcional 13.1, al 4to día para revisar los hallazgos con Vicepresidencia Jurídica                        
                        <%--¿En qué fecha se llevará a cabo la reunión 8.1 .-Revisión de la presentación de hallazgos con la Vicepresidencia Jurídica?--%>
                    </div>
                    <br />
                    <div class="MensajeModal-UI">
                        <asp:TextBox ID="txtFechRevHallazgoss" runat="server"></asp:TextBox>
                        <ajx:CalendarExtender ID="ceFechaCampoHallazgoss" runat="server" Format="dd/MM/yyyy" PopupButtonID="imgFechaCampo22"
                            TargetControlID="txtFechRevHallazgoss" CssClass="teamCalendar" />
                        <asp:Image ID="imgFechaCampo22" runat="server" ImageUrl="../Imagenes/Calendar.GIF" Width="16px"
                            ImageAlign="Bottom" Height="16px" />
                        <br />
                        <br />
                        <img src="../Imagenes/ORIENTACION.png" alt="" width="10" height="10" />
                        <b>Recuerda: </b>
                        <asp:Label ID="lblInfoPregunta81s" runat="server" Text="La fecha no puede ser mayor a 4 días hábiles a partir de hoy." Font-Size="Small" ForeColor="Black" Visible="true"></asp:Label>
                        <br />
                        <asp:Label ID="lblPresentaHallazgoss" runat="server" Text="*Texto dinamico." Font-Size="Small" ForeColor="Red" Visible="false"></asp:Label>
                    </div>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td style="text-align: center" colspan="2">
                    <div id="dvRdo" runat="server" visible="false">
                        ...
                        <img src="../Imagenes/ORIENTACION.png" alt="" width="10" height="10" />
                        <b>Recuerda: </b>
                        <asp:Label ID="lblInfoValFechaIngresada" runat="server" Visible="false" Text="" Font-Size="Small" ForeColor="Black"></asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div id="divMensajeSISAN" style="display: none">
        <table width="100%">
            <tr>
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        <label id="lblMensajeSISAN"></label>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <script type="text/javascript">
        ...
        //Se implenentara en el nuevo metodo de Elegir fecha tentativa de la reunión opcional 13.1 para revisar respuesta de la AFORE con Jurídico"
        function SolicitaFechaRevHallazgosP13() {
            MensajeDosBotonesUnaAccionAgc("dvFechaRevisionHallazgosVJp13", "btnFechaRevHallazgosp13", 550, 420);
        }
        ...
        function SolicitarFechaReunionEntidad() {
            $("#divTituloFechaGeneral").text("Favor de ingresar la fecha para revisar presentacion de hallazgos:");
        ...
        function SolicitarFechaReunionRetroComentAtendidosActaConclusion() {
            $("#divTituloFechaGeneral").text("¿En qué fecha será la reunión 15.1.- Retroalimentación de comentarios a acta de conclusión?");
        ...
        function SolicitarFechaReunPreciJuridico() {
            //$("#divTituloFechaGeneral").text("Elegir fecha tentativa de la reunión opcional de revisión de acta circunstanciada con el área jurídica. ");
            $("#divTituloFechaGeneral").text("Elegir fecha tentativa de la reunión opcional 8.1 de revisión de acta circunstanciada con el área jurídica ");
            MensajeDosBotonesUnaAccionAgc("divFechaGeneral", "btnFechaReunionVj", 550, 370);
        }

        function SolicitarFechaReunPreciJuridicoP16() {
            $("#divTituloFechaGeneral").text("¿En qué fecha será la reunión 14.1.- Revisión de acta de conclusión con la Vicepresidencia Jurídica?");
            MensajeDosBotonesUnaAccionAgc("divFechaGeneral", "btnFechaReunionVjP16", 550, 370);
        }

       // ///PASO 9 INICIA
       // function ConfirmarFechaReunPreciJuridico() { /*SE CAMBIA EL TEXTO DE 9.1 A 8.1*/
       //     $("#divTituloFechaGeneral").text("La fecha de la reunión 68.1 – Revisión de Acta Circunstanciada con el área de Supervisión fue:");
       ...
       ///PASO 9 INICIA
       function ConfirmarFechaReunPreciJuridico() { /*SE CAMBIA EL TEXTO DE 9.1 A 8.1*/
          $("#divTituloFechaGeneral").text("La fecha de la reunión 8.1 – Revisión de Acta Circunstanciada con el área de Supervisión fue:");
          ConfirmacionAceptarCancelar("divFechaGeneral", "btnConfFechaReunionVjp9", "btnCancelaFechaReunionVjp9", 1, 550, 370);
          return false;
       }
        ...
        function ConfirmarFechaReunRevisionPresentacionHallazgos() {
            $("#divTituloFechaGeneral").text("La fecha de la reunión opcional 8.1 - Revisión de la presentación de hallazgos fue:");
        ...
        ///*Se implementa Confimacion de paso 13.1 de FECHA*/
        //function ConfirmaFechaReunionRevisionP13() {
        //    ConfirmacionvJ("divMensajeUnBotonNoAccion", "btnConfFechaReunionP8ok", "btnConfFechaReunionP8No", 1, "btnConfFechaReunionP8NoDos", 550, 370);
        //}
        ///PASO 9 FIN
        ...
        function ConfirmarFechaReunPreciJuridicoP16() {
            $("#divTituloFechaGeneral").text("La fecha de la reunión 14.1 - Revisar Acta de conclusión con el área de Supervisión fue:");
            ...
            ConfirmacionAceptarCancelar("divFechaGeneral", "btnConfFechaReunionVjp16", "btnCancelaFechaReunionVjp16", 1, 550, 370);
        }
        

        //La reunión 13.1 para revisar la respuesta de la AFORE con VJ se llevó a cabo en la fecha
        
        function ConfirmarFechaReunP13() {
            ConfirmacionvJ("divMensajeUnBotonNoP13", "btnConfFechaP13OK", "btnConfFechaP13NO", 1, "btnConfFechaP13NoDos", 550, 370);
        }
        ...
        function ConfirmarFechaReunPaso18() { /*Se MODIFICO POR GP 18.1 A 15.1*/
            $("#divTituloFechaGeneral").text("La fecha de la reunión 15.1 - Retroalimentación de Acta de conclusión fue:");
        ...
        function PreguntaReunionVjPresidencia() {
            ...
            //$("div#divMensajeDosBotonesUnaAccion_PresiVJ").attr("title", "Confirmación de reunión");
            ...
            //MensajeDosBotonesUnaAccion_NoPresentacionPresiVJ("div#divMensajeDosBotonesUnaAccion_PresiVJ", "btnPasoSieteConfirmSi", "btnPasoSieteConfirmNo", 1, 550, 370);
        }
        ...
        function PreguntaReunionVjPresidencia_V17() {
            ...
            //$("div#divMensajeDosBotonesUnaAccion_PresiVJ").attr("title", "Confirmación de reunión");
            //Habrá Presentación con VJ y Presidencia?
            Continuar("divMensajeConfirmaDetalleVisita", "btnPasoSieteConfirmNo_V17", 550, 370)
        ...
        function RegistroSISAN() {
           
            $.ajax({
                type: "POST",
                async: false,
                url: "DetalleVisita_V17.aspx/ValidacionSISAN",
                data: '{"Folio":' +  <%=If(IsNothing(ppObjVisita), 0, ppObjVisita.IdVisitaGenerado)%> + ',"FolioVisita":"' + '<%=If(IsNothing(ppObjVisita), "", ppObjVisita.FolioVisita)%>' + '","FechaInicioActoSup":"' + '<%=If(IsNothing(ppObjVisita), "", ppObjVisita.FECH_VISITA_CAMPO__INI)%>' + '","FechaFinActoSup":"' + '<%=If(IsNothing(ppObjVisita), "", ppObjVisita.FECH_VISITA_CAMPO__FIN)%>' + '","Usuario":"' + '<%=If(IsNothing(ppObjVisita), "", ppObjVisita.Usuario.IdentificadorUsuario)%>' + '","IdEntidad":' + <%=If(IsNothing(ppObjVisita), 0, ppObjVisita.IdEntidad)%> + ',"IdTipoEntidad":'+ <%=If(IsNothing(ppObjVisita), 0, ppObjVisita.IdTipoEntidad)%> + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                   
                    $("#divMensajeConfirmacion").dialog("close");
                    /*Mostrar mensaje Se ha registrado correctamente en SISAN con el número de Folio [FOLIO_SISAN].*/
                   
                    MostrarMensajeSISAN(data.d);
                },
                failure: function (error) {
                    MostrarMensajeSISAN("Error al realizar registro en SISAN.");
                }
            });
        }
        function MostrarMensajeSISAN(folio) {
            let esRegistroExitoso = 0;          
            if (folio.indexOf("Error") == -1) {
                $('#lblMensajeSISAN').text('Se ha registrado correctamente en SISAN con  el número de Folio: ' + folio + '.');
                esRegistroExitoso = 1;
            }
            else {
                $('#lblMensajeSISAN').text(folio);
            }
            $("#divMensajeSISAN").dialog({
                resizable: false,
                autoOpen: true,
                height: 200,
                width: 400,
                ...
                buttons: {
                    "Aceptar": function () {
                        if (esRegistroExitoso == 1) {
                            ActualizarEstatusEnviadoSISAN();
                        } else {
                            $(this).dialog("close");
                        }
                    }
        ...
        function ActualizarEstatusEnviadoSISAN() {           
            $.ajax({
                type: "POST",
                async: false,
                url: "DetalleVisita_V17.aspx/ActualizarEstatusEnviadoSISAN",
                data: '{"IdVisita":' + <%=If(IsNothing(ppObjVisita), 0, ppObjVisita.IdVisitaGenerado)%> + ',"IdArea":' + <%=If(IsNothing(ppObjVisita), 0, ppObjVisita.IdArea)%> + ',"Usuario":' + '"<%=If(IsNothing(puObjUsuario), 0, puObjUsuario.IdentificadorUsuario)%>"' + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {                   
                    $('#divMensajeSISAN').dialog("close");
                    $(location).attr('href', './DetalleVisita_V17.aspx');
                },
                failure: function (error) {
                    MostrarMensajeSISAN("Error al actualizar registro a estatus 'Enviado a SISAN.'");
                }
            });
        }
        function GuardarBitacora(folio, usuario, paso, accion, comentarios) {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "DetalleVisita_V17.aspx/GuardarBitacota",
                contentType: "application/json;charset=utf-8",
                data: '{Folio: ' + folio +
                    ', Usuario: "' + usuario +
                    '", Paso: "' + paso +
                    ...
                    "Cancelar": function () {
                        ...
                        if (nombreBotonNo == 'btnPasoSieteConfirmNoSnPostback') { //TRUQUEARLO PARA LA FUNCIONALIDAD ESPECIFICA SE SANCION EN PASO 7
                            ...
                            if (ejecutarTriggerBtnNo == 1) {
                                $(this).dialog("option", "buttons", [{ text: "Aceptar", disabled: true }, { text: "Procesando...", disabled: true }]);
                                $('#' + nombreBotonNo).trigger("click");
                            } else {
                                $(this).dialog("close");
                            }
        ...
        function ObtenerDatosIrregularidad(RowIndex, nIDIrreg) {
            $.ajax({
                type: "POST",
                url: "DetalleVisita_V17.aspx/ObtenerDatosModificarIrregularidad",
                ...
                success: function (data) {
                    ...
                    folioVisita = jsonData.d[7];
                    $("#<%=txtFecIrregularidadModifica.ClientID%>").val(jsonData.d[0]);
                    document.getElementById('<%=txtFecIrregularidadModifica.ClientID%>').value = jsonData.d[0];
                    let ddlProcesoModifica = document.getElementById('ddlProcesoModifica');
                    ddlProcesoModifica.value = jsonData.d[1];
                    let event = new Event('change');
                    ddlProcesoModifica.dispatchEvent(event);
                    let ddlSubProceso = document.getElementById('ddlSubProcesoModifica');
                    ddlSubProceso.value = jsonData.d[2];
                    ddlSubProceso.dispatchEvent(event);
                    let ddlConducta = document.getElementById('ddlConductaModifica');
                    ddlConducta.value = jsonData.d[3];
                    ddlConducta.dispatchEvent(event);
                    let ddlIrregularidad = document.getElementById('ddlIrregularidadModifica');
                    ddlIrregularidad.value = jsonData.d[4];
                    $("#TxtComentariosModifica").val(jsonData.d[5]);
                    jsRemoveWindowLoad();
                    return true;
                },
                failure: function () {
        ...
        function MostrarModificaIrregularidad(rowI, idIrregularidad) {
            MuestraImgCarga();
            $("#LblErrorIrregularidad").css('display', 'none');
            ObtenerProcesosDdl();
            ...
            $("#modificarIrregularidad").dialog({
                ...
                buttons: {
                    "Aceptar": function () {
                        debugger;
                        if (ModificaIrregularidad(idIrregularidad) == true)
                            $(this).dialog("option", "buttons", [{ text: "Procesando...", disabled: true }, { text: "Cancelar", disabled: true }]);
                    },
                    "Cancelar": function () {
                        $(this).dialog("close");
        ...
        function ObtenerProcesosDdl() {
            /*
            debugger;
            let ddlProcesoModificaVerificacion = $("[id*=ddlProcesoModifica]");
            if (ddlProcesoModificaVerificacion.length > 1)
                return;
            */

            $.ajax({
                type: "POST",
                url: "DetalleVisita_V17.aspx/ObtenerProcesos",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function ddlProcesoOnchange() {
            try {
                $.ajax({
                    type: "POST",
                    url: "DetalleVisita_V17.aspx/ObtenerSubProcesos",
                    data: '{Proceso:' + parseInt(document.getElementById('ddlProcesoModifica').value) + '}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
                    success: function (data) {
                        var ddlSubProceso = $("[id*=ddlSubProcesoModifica]");
        ...
        function ddlSubProcesoOnChange() {
            $.ajax({
                type: "POST",
                url: "DetalleVisita_V17.aspx/ObtenerConducta",
                data: '{Proceso:' + parseInt(document.getElementById('ddlProcesoModifica').value) +
                    ',SubProceso:' + parseInt(document.getElementById('ddlSubProcesoModifica').value) + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (data) {
                    var ddlConducta = $("[id*=ddlConductaModifica]");
        ...
        function ddlConductaOnChange() {
            $.ajax({
                type: "POST",
                url: "DetalleVisita_V17.aspx/ObtenerIrregularidad",
                data: '{Proceso:' + parseInt(document.getElementById('ddlProcesoModifica').value) +
                    ',SubProceso:' + parseInt(document.getElementById('ddlSubProcesoModifica').value) +
                    ',Conducta:' + parseInt(document.getElementById('ddlConductaModifica').value) + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (data) {
                    var ddlIrregularidad = $("[id*=ddlIrregularidadModifica]");
        ...
        function ModificaIrregularidad(idIrregularidad) {
            ...
            let ddlConducta = document.getElementById('ddlConductaModifica');
            let ddlIrregularidad = document.getElementById('ddlIrregularidadModifica');
            if ($("#txtFecIrregularidadModifica").val() == '' ||
            ddlProcesoModifica.value <= 0 || ddlSubProceso.value <= 0
            || ddlConducta.value <= 0 || ddlIrregularidad.value <= 0
            || $("#TxtComentariosModifica").val() == ''
            ) {
                $("#LblErrorIrregularidad").text('Debes llenar la información obligatoria.');
                $("#LblErrorIrregularidad").css('display', 'block');
            return false;
        }
        ...
        $.ajax({
            type: "POST",
            url: "DetalleVisita_V17.aspx/ActualizarIrregularidad",
            async: false,
            data: '{Folio: ' + folioVisita +
                ', IdIrregularidad: ' + idIrregularidad +
                ', Fecha: "' + $("#txtFecIrregularidadModifica").val() +
                ...
                '", Comentarios: "' + $("#TxtComentariosModifica").val() + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    <asp:Button runat="server" ID="btnPasoSieteConfirmSi" Visible="False" Style="display: none" ClientIDMode="Static" OnClick="btnPasoSieteConfirmSi_Click" />
    ...
    <asp:Button runat="server" ID="btnPasoSieteConfirmSi_V17" Visible="False" Style="display: none" ClientIDMode="Static" OnClick="btnPasoSieteConfirmSi_V17_Click" />
    ...
    <asp:Button runat ="server" ID ="btnConfFechaP13OK" Style="display: none" ClientIDMode="Static" OnClick ="btnConfFechaP13OK_Click" />
    <asp:Button runat ="server" ID ="btnConfFechaP13NO" Style="display: none" ClientIDMode="Static" OnClick ="btnConfFechaP13NO_Click" />
    <asp:Button runat ="server" ID ="btnConfFechaP13NoDos" Style="display: none" ClientIDMode="Static" OnClick ="btnConfFechaP13NoDos_Click" />
    ...
    <%--Se implementa Button Paso 13.1--%> <%--btnFechaRetroalimentacion--%>
    <asp:Button runat ="server" ID ="btnFechaRetroalimentacionP13" Style="display: none" ClientIDMode="Static" OnClick ="btnFechaRetroalimentacionP13_Click" />
     <asp:Button runat="server" ID="btnFechaRevHallazgosp13" Style="display: none" ClientIDMode="Static" />
    ...
    <asp:HiddenField ID="hfFlujoActualPaso" runat="server" ClientIDMode="Static" />
    <div id="modificarIrregularidad" style="display: none" title='Modificar Irregularidad'>
        <table width="100%">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Fecha de irregularidad" CssClass="txt_gral"></asp:Label>
                    <span style="color:red">&nbsp;*</span>
                </td>
                <td>
                    <asp:TextBox ID="txtFecIrregularidadModifica" runat="server" Width="290px" CssClass="txt_gral" ClientIDMode="Static"></asp:TextBox>

                    <ajx:calendarextender ID="Calendarextender2" runat="server" Format="dd/MM/yyyy" PopupButtonID="imgCal"
                        TargetControlID="txtFecIrregularidadModifica" CssClass="teamCalendar" />
                    <asp:Image ImageAlign="Bottom" ID="Image22" runat="server" ImageUrl="~/imagenes/Calendar.gif" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="Proceso" CssClass="txt_gral"></asp:Label><span style="color:red">&nbsp;*</span>
                </td>
                <td>
                    
                    <select id="ddlProcesoModifica" onchange="ddlProcesoOnchange()" style="width:290px"></select>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="Subproceso" CssClass="txt_gral"></asp:Label><span style="color:red">&nbsp;*</span>
                </td>
                <td>
                    
                    <select id="ddlSubProcesoModifica" onchange="ddlSubProcesoOnChange()"  style="width:290px"></select>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Text="Conducta sancionable" CssClass="txt_gral"></asp:Label>
                    <span style="color:red">&nbsp;*</span>
                </td>
                <td>
                    <select id="ddlConductaModifica" onchange="ddlConductaOnChange()" style="width:290px"></select>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="Irregularidad" CssClass="txt_gral"></asp:Label>
                    <span style="color:red">&nbsp;*</span>
                </td>
                <td>
                    <select id="ddlIrregularidadModifica" style="width:290px"></select>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="Comentarios adicionales<br>de la irregularidad" CssClass="txt_gral"></asp:Label>
                    <span style="color:red">&nbsp;*</span>
                </td>
                <td>
                    <asp:TextBox ID="TxtComentariosModifica" runat="server" CssClass="txt_gral" Height="45px" Width="290px"
                        TextMode="MultiLine" MaxLength="500" ClientIDMode="Static"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <label id="LblErrorIrregularidad" style="color:red;display:none;" ></label>
                </td>
            </tr>
        </table>
    </div>
